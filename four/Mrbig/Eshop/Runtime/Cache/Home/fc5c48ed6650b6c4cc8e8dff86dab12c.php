...
<div class="Inside_pages"> 
    <!--位置-->
    <div id="Filter_style">
       <h2><div class="Location_link"> <em></em><a href="#">您好，<b style="color: red;font-size: 18px">“<?php echo ($keywords); ?>”&nbsp;</b>共搜索到</a> &lt; <a href="#"><?php echo ($total); ?>件商品</a> </div></h2>
        <!--产品列表样式-->
    <div class="p_list  clearfix">
        <ul>
            <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><li class="gl-item"> <em class="icon_special tejia"></em>
                <div class="Borders" >
                    <div class="img"><a href="#" onclick="window.location.href='<?php echo u('Goods/goods',array('id'=>$val['id']));?>'"><img src="/upload/n1/<?php echo (array_shift(explode(',',$val["pic"]))); ?>" style="width:220px;height:220px"></a></div>
                    <div class="name">
                        <h2><a href="#">
                        <?php echo mb_substr($val['name'],0,12,"utf-8");?>
                        </a></h2>
                    </div>
                    <div class="Shop_name"><a href="#">两只老鼠旗舰店</a></div>
                    <div class="yushou">
                        <div class="yushou-p fl">¥<strong><?php echo ($val['price']); ?></strong></div>
                        <a href="">
