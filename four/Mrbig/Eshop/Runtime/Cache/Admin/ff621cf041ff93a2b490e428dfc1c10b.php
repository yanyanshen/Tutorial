    ...
    <tr>
        ...
        <td valign="top" background="/Public/Admin/Images/content_bg.gif">
            <table width="100%" height="31" border="0" cellpadding="0" cellspacing="0" background=".//Public/Admin/Images/content_bg.gif">
                <tr><td height="31"><div class="title">已付款订单</div></td></tr>
            </table>
        </td>
                                    ...
                                    <form action="" method="" id="form1">
                                        <table width="100%" border="0" cellpadding="0" cellspacing="0" class="list_table">
                                            ...
                                            <?php if(is_array($arr)): $k = 0; $__LIST__ = $arr;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($k % 2 );++$k;?><tr class="tr">
                                                    ...
                                                    <td><img id="pay" src="/Public/Admin/pay/p2.jpg" width="40" height="40" /></td>
                                                    <td>
                                                        <a href="javascript:see(<?php echo ($vo["id"]); ?>)" class="ext_btn ext_btn_submit">订单详情</a>
                                                        <div class="ext_btn ext_btn_submit" href="#"  onclick="send(<?php echo ($vo['id']); ?>)">确认发货</div>
                                                    </td>
...
<script>
    ...
    function send(id) {
        layer.confirm('确定要发货吗？', {
            ...
            $.post("<?php echo U('/Admin/Order/send');?>", {'id': id}, function (res) {
                if (res.status == 'ok') {
                    layer.confirm(res.msg,{
                        btn: ['继续发货', '已发货列表']
                    },function(){
                          location.href = "<?php echo U('/Admin/Order/order_2');?>";
                            },
                            function(){
                                location.href = "<?php echo U('/Admin/Order/order_3');?>";
                            }
                )
