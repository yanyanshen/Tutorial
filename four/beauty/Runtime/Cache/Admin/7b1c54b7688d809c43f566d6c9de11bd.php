...
<table class="tablelist">
    ...
    <?php if(is_array($goodslist)): $k = 0; $__LIST__ = $goodslist;if( count($__LIST__)==0 ) : echo "$empty" ;else: foreach($__LIST__ as $key=>$val): $mod = ($k % 2 );++$k;?><tr>
            ...
            <td style="font-size: 10px;"><a href="<?php echo U('Admin/Golds/editor',array('gid'=>$val['id']));?>" class="tablelink">编辑&nbsp;&nbsp;&nbsp;&nbsp;</a><a href="<?php echo U('Admin/Golds/updateshow',array('gid'=>$val['id']));?>" class="tablelink"><?php echo ($val['show']==1?'下架':'展示'); ?></a></td>
