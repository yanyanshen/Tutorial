...
/*添加分类三级联动*/
        var getCate=function(pid,name){
            $.post('<?php echo U("Admin/Category/getCateByPid");?>',{pid:pid},function(res){
                if(res.status){
...
/*向分类表中添加分类*/
        $('.btn').click(function(){
            $.post('<?php echo U("Admin/Category/editorCateByPid");?>',$("#form1").serialize(),function(res){
             if(res.info=='编辑成功'){
                    ...
                    layer.msg('编辑失败',function(){
                        location='<?php echo U("Category/editorCate");?>'
                    });
                }
            })
        });
    ...
    <div id="usual1" class="usual">
        <div id="tab1" class="tabson">
            <form action="" method="post" id="form1">
                <ul class="forminfo">
                    <li><label>分类名称<b>*</b></label><input name="cname" type="text" class="dfinput" value="<?php echo ($cname); ?>"    style="width:240px;"/></li>
