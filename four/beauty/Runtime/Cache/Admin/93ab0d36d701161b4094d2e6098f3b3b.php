...
<script language="javascript">
	$(function(){
        ...
        $('#form1').submit(function(){
            if(validate.form()){
                $.post("<?php echo U('Admin/Login/forgetPwd');?>",$('#form1').serialize(),function(res){
                    if(res.status==1){
                       layer.msg(res.info,{time:2000,icon:6},function(){
                        ...
                        layer.msg(res.info,{time:2000,icon:5},function() {
                            window.location.href="<?php echo U('Admin/Login/forgetPwd');?>";
                        })
                    }
                },'json');
                return false;
...
<div class="loginbody">
    ...
    <div class="loginbox loginbox3">
        ...
        <ul style="margin-top: 40px">
            <li><h3 style="font-size: 20px;margin-left: 110px;margin-bottom: 20px;color: #EF5B00">修改密码</h3></li>
            <li><input name="username" type="text" class="loginuser" placeholder="用户名" onclick="JavaScript:this.value=''"/></li>
            <li><input name="mobile" type="password" class="loginuser" placeholder="手机号" onclick="JavaScript:this.value=''"/></li>
            <li><input name="password" type="password" class="loginpwd" placeholder="请输入新密码" onclick="JavaScript:this.value=''"/></li>
            <!--<li class="yzm">
            ...
            <li style="margin-left: 80px">
                <input name="" type="button" class="loginbtn" value="提交修改" />
                <label><a href="<?php echo U('login');?>">用户登录</a></label>
            </li>
        </ul>
        </form>
    </div>
...
<script src="/Public/Admin/js/index.js" charset="utf-8"></script>
