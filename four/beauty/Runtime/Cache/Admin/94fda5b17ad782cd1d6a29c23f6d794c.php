...
<head>
    ...
    <script type="text/javascript">
        $(document).ready(function(e) {
            ...
            /*向分类表中添加分类*/
            $('.btn').click(function(){
                $.post('<?php echo U("Admin/Foote/addCateByPid");?>',$("#form1").serialize(),function(res){
                    if(res.info=='分类名不能为空'){
                        layer.msg('分类名不能为空');
                    }if(res.info=='分类名已经存在'){
                        layer.msg('分类名已经存在');
    ...
    <div id="usual1" class="usual">
        <div id="tab1" class="tabson">
            <form action="" method="post" id="form1">
                <ul class="forminfo">
                    <li><label>分类名称<b>*</b></label><input name="fname" type="text" class="dfinput" value=""    style="width:240px;"/></li>
