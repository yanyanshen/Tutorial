...
<body style="background:#f0f9fd;">
    ...
    <!--<dl class="leftmenu">
        ...
        <dd>
            ...
            <ul class="menuson">
                <li class="active">
                    <div class="header">
                        <cite></cite>
                        <a href="<?php echo U('Admin/Category/index');?>" target="rightFrame">分类列表</a>
                        <i></i>
                    </div>
                </li>
                ...
                <li>
                    <div class="header">
                    <cite></cite>
                    <a href="<?php echo U('Category/add');?>" target="rightFrame">添加分类</a>
                    <i></i>
                    </div>
                </li>
        ...
        <dd>
            <div class="title">
                <span><img src="/Public/Admin/images/leftico01.png" /></span>活动发布
            </div>
            <ul class="menuson">
                <li class="active">
                    <div class="header">
        ...
        <dd>
            <div class="title">
                <span><img src="/Public/Admin/images/leftico01.png" /></span>评论管理
            </div>
            <ul class="menuson">
                <li class="active">
                    <div class="header">
        ...
        <dd>
            <div class="title">
                <span><img src="/Public/Admin/images/leftico01.png" /></span>反馈管理
            </div>
            <ul class="menuson">
                <li class="active">
                    <div class="header">
                        <cite></cite>
                        <a href="<?php echo U('Admin/Feedback/index');?>" target="rightFrame">反馈列表</a>
                        <i></i>
                    </div>
                </li>
            </ul>
        ...
        <dd>
            <div class="title">
                <span><img src="/Public/Admin/images/leftico01.png" /></span>金币商城
            </div>
            <ul class="menuson">
                <li class="active">
                    <div class="header">
