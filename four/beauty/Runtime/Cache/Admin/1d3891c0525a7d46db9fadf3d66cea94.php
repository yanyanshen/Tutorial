...
$(document).ready(function(e) {
    ...
    var getCate=function(pid,name,id){
        $.post('<?php echo U("Admin/Golds/getCateByPid");?>',{pid:pid},function(res){
            if(res.status){
                var str='';
 ...
 /*   getCate(0,'firstCate');*/
    ...
    $.post("<?php echo U('Admin/Golds/brandlist');?>",function(res){
        if(res.status){
...
<body>
 ...
 <form action="<?php echo U('Admin/Golds/editor');?>" id="editor" method="post" enctype="multipart/form-data">
    <ul class="forminfo">
    ...
    <li><label>商品名称<b>*</b></label><input name="goodsname" type="text" class="dfinput" value="<?php echo ($goodsOne["goodsname"]); ?>"  style="width:518px;"/></li>
        ...
        <li><label>销售价格<b>*</b></label><input name="saleprice" type="text" class="dfinput" value="<?php echo ($goodsOne["saleprice"]); ?>" style="width:345px;"></li>
