...
<div class="formbody">
    ...
    <div id="usual1" class="usual">
        ...
        <div id="tab2" class="tabson">
            ...
            <form action="<?php echo U('Comment/search1',array('respid'=>1));?>" method="get" id="form1">
                <ul class="seachform">
                    <li>
                        <label>评价时间：</label>
            ...
            <script type="text/javascript">
                $(function(){
                    $('.pilresponse').click(function(){
                        location.href="<?php echo U('Admin/Comment/duoresponse',array('cosid'=>$cosid));?>";
                    })
                })
            </script>
            <table class="tablelist" style="text-align: center;">
                ...
                <?php if(is_array($commentList)): $k = 0; $__LIST__ = $commentList;if( count($__LIST__)==0 ) : echo "$empty" ;else: foreach($__LIST__ as $key=>$val): $mod = ($k % 2 );++$k;?><tr>
                        ...
                        <td>
                            <a href="<?php echo U('Comment/response',array('oid'=>$val['oid'],'gid'=>$val['gid'],'mid'=>$val['mid'],'coaddtime'=>$val['coaddtime']));?>" class="tablelink"><?php echo ($val['respid']==1?'回复':''); ?></a>
                        </td>
