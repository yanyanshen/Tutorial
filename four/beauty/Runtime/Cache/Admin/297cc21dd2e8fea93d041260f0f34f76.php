                ...
                $.post('<?php echo U("Admin/Order/sendGoods");?>',{id:id},function(res){
                    if(res.status==1){
                        layer.msg('发货完成',{time:1000},function(){
                            location="<?php echo U('Admin/Order/dfh');?>";
                        });
                    }
                })
            })
...
<body>
    ...
    <ul class="seachform">
    <li><label>订单编号</label><input name="keywords" type="text" style="width: 80px;height:25px;border: 1px solid #cccccc;" class="scinput" value="<?php echo ($keywords); ?>"/></li>
        <li>
            <label>创建时间：</label>
    ...
    <table class="tablelist">
        ...
        <th><i class="sort"><img src="/Public/Admin/images/px.gif" /></i>编号</th>
        <th>用户名</th>
        <th>订单序列号</th>
        <th>订单价格</th>
        <th>订单创建时间</th>
        ...
        <td><input name="" type="checkbox" value="" /></td>
            ...
            <td><a href="#" class="layer" style="color:#ef5b00;" gid="<?php echo ($val["id"]); ?>"><?php echo ($val["adminstatus"]); ?></a> </td>
