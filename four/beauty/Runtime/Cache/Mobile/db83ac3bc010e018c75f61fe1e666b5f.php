...
<div class="order-list">
    ...
    <form action="<?php echo U('Mobile/Comment/usercomment');?>" id="comment" method="post" enctype="multipart/form-data">
    ...
    <section>
        ...
        <div class="order-list-Below">
                ...
                <ul class="list" style="margin: 0;padding: 0;">
                    <li class="good">
                        <label for="rate-good-2472159552941165">
                            <input type="radio" id="rate-good-2472159552941165" name="<?php echo ($v["id"]); echo ($v["ml"]); ?>[pingjia][]" value="1" checked />
                            <i title="好评"><span class="xubitu1"></span></i>
                        </label>
                    </li>
                    <li class="normal">
                        <label for="rate-normal-2472159552941165">
                            <input type="radio" id="rate-normal-2472159552941165"   name="<?php echo ($v["id"]); echo ($v["ml"]); ?>[pingjia][]" value="2" />
                            <i  title="中评"><span class="xubitu2"></span></i>
                        </label>
                    </li>
                    <li class="bad">
                        <label for="rate-bad-2472159552941165">
                            <input type="radio"  id="rate-bad-2472159552941165"   name="<?php echo ($v["id"]); echo ($v["ml"]); ?>[pingjia][]" value="3" />
            ...
            <div class="order-textbox">
                <textarea placeholder="在此输入商品评价" name="<?php echo ($v["id"]); echo ($v["ml"]); ?>[content]" style="color: black;"></textarea>
            </div>
    ...
    <div class="order-button">
        <a href="javascript:void(0);" class="btn">发表评论</a>
    </div>
</div>
<script type="text/javascript">
    $(function(){
        $('.btn').click(function(){
            if($('.order-textbox textarea').val().length<10){
                layer.open({
