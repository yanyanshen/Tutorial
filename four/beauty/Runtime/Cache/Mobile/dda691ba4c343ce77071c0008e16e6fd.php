 ...
 <body> 
  <div class="body"> 
   <div class="m_header"> 
    ...
    <h1 class="ellipsis bt_title" style="margin-top:3%"> 列表页 </h1>
   ...
   <div class="lib_content" id="js_lib_content"> 
    ...
    <div class="m_tab_select">
        <?php if($_SESSION['beauty_']['moren']== 'moren'): ?><a class="orange" href="<?php echo U('Mobile/GoodsList/goodslist',array('moren'=>'moren'));?>">默认</a>
            <?php else: ?>
            <a  href="<?php echo U('Mobile/GoodsList/goodslist',array('moren'=>'moren'));?>">默认</a><?php endif; ?>
        <?php if($_SESSION['beauty_']['collect']== 'g.collectnum'): ?><a class="orange" href="<?php echo U('Mobile/GoodsList/goodslist',array('collect'=>'collectnum'));?>">热卖</a>
            <?php else: ?>
            <a  href="<?php echo U('Mobile/GoodsList/goodslist',array('collect'=>'collectnum'));?>">热卖</a><?php endif; ?>
        <?php if($_SESSION['beauty_']['price1']== 'g.saleprice'): ?><a class="orange" href="<?php echo U('Mobile/GoodsList/goodslist',array('price1'=>'saleprice'));?>" >&nbsp;价格</a>
        <?php else: ?>
        <a href="<?php echo U('Mobile/GoodsList/goodslist',array('price1'=>'saleprice'));?>" >&nbsp;价格</a><?php endif; ?>
            ...
            <div class="lists clearfloat">
                <div class="bottom clearfloat">
                    <?php if(is_array($goodsList)): $i = 0; $__LIST__ = $goodsList;if( count($__LIST__)==0 ) : echo "$empty" ;else: foreach($__LIST__ as $key=>$data): $mod = ($i % 2 );++$i;?><div class="lie clearfloat">
                            <a href="<?php echo U('Mobile/Goods/goodsdetail',array('gid'=>$data['gid']));?>">
                            ...
                            <br>
                            <a href="<?php echo U('Mobile/Goods/goodsdetail',array('gid'=>$data['gid']));?>">
                                <p  style="font-size:0.3rem;color: #ff6c4c">￥<?php echo ($data['saleprice']); ?></p>
                            </a>
                            <br>
                            ...
                            <span  style="margin-left: 50%" class="fr db" gid="<?php echo ($data['gid']); ?>">收藏</span>
...
<script>
    ...
    $("#js-filter1").click(function(){
        ...
        '<form method="get" id="form1" action="<?php echo U('Mobile/GoodsList/goodslist');?>">'+
            ...
            $.get("<?php echo U('Mobile/Search/collectGoods');?>?gid="+gid,function(res){
                if(res.status==1){
                    ...
                    if(res.info=='该商品已经在收藏夹里哦'){
                        ...
                        location.href='<?php echo U("Login/Dologin");?>'
                    }
                }
            })
        })
