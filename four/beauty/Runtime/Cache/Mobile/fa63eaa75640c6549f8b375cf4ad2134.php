...
<div class="body">
    ...
    <div class="lib_content" id="js_lib_content">
        ...
        <form id="js-form" action="" method="post">
            <?php if(is_array($footInfo)): $i = 0; $__LIST__ = $footInfo;if( count($__LIST__)==0 ) : echo "$empty" ;else: foreach($__LIST__ as $key=>$info): $mod = ($i % 2 );++$i;?><div class="goodsbox">
                    <ul class="goodslist">
                        <li>
                            <div class="img">
                            ...
                            <div class="price">
                                ...
                                <a href="javascript:;" gid="<?php echo ($info["gid"]); ?>" class="delete" style="color: black;margin-top: 15px;display: inline-block;">删除</a>
                            </div>
    ...
    <script>
        $(".delete").click(function(){
            if($('.m_radio ').hasClass('m_checked')){
                ...
                var a=$(this);
                $.get('<?php echo U("Mobile/Footprint/deletefoot");?>?gid='+gid,function(res){
                    if(res.status==1){
                        layer.open({
                            content:'删除成功'
                            ,skin:'msg'
        ...
        $(".alldelete").click(function(){
            if($('.m_radio ').hasClass('m_checked')){
                $.get('<?php echo U("Mobile/Footprint/deleteAll");?>',function(res){
                    if(res.status==1){
                        layer.open({
                            content:'删除成功'
                            ,skin:'msg'
                            ,time:3
                            ,end:function(){
                                location='<?php echo U("Footprint/footprint");?>'
                            }
                        })
                    }
                })
