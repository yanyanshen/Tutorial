...
<div class="page-role cart-page cart-trolly-page" id="js-cart-trolly-page">
    ...
    <div style="float: left;margin-left: 10px;">
        <a title="返回" href="javascript:history.back(-1);" style="color: white;">
            &lt;&nbsp;&nbsp;添加新地址
        </a>
    </div>
        ...
        $('.save').click(function(){
            ...
            $('#address').submit(function(){
                if(validate.form()){
                    ...
                    $.post("<?php echo U('Mobile/ManageAddress/add');?>",$('#address').serialize(),function(response){
                        if(response.status==1){
                            layer.open({
                                ...
                                ,end:function(){
                                    location="<?php echo U('Mobile/ManageAddress/manageAddress');?>"
                                }
                            });
                        }else{
                            layer.open({
