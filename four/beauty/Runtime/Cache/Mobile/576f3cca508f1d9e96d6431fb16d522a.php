 ...
 <body> 
  <div class="body"> 
   <div class="m_header"> 
    ...
    <h1 class="ellipsis bt_title"> 账户管理 </h1> 
   ...
   <div class="lib_content" id="js_lib_content"> 
    <ul class="m_list bg_white"> 
     <li class="link"> <a href="<?php echo U('Member/chgPwd');?>"> <i class="m_icon m_icon_lock"></i>&nbsp;&nbsp; 修改登录密码
       <div class="right"> 
        <span class="m_arrow"> <i class="rotate45"></i> <i class="rotate135"></i> </span> 
       </div> </a> </li> 
     <li class="link"> <a href="<?php echo U('Address/totaladdresslist');?>"> <i class="m_icon m_icon_address"></i>&nbsp;&nbsp; 收货地址
       <div class="right"> 
        <span class="m_arrow"> <i class="rotate45"></i> <i class="rotate135"></i> </span> 
       </div> </a> </li> 
    </ul> 
