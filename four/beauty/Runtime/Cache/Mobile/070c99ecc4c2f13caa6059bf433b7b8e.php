...
<html>
 <head> 
  ...
  <link rel="stylesheet" href="css/zip.touch.member2_0.index.v39016.css" type="text/css" /> 
 ...
 <body> 
  <div class="body"> 
   <div class="m_header"> 
    ...
    <h1 class="ellipsis bt_title"> 我的拍鞋 </h1> 
   ...
   <div class="lib_content" id="js_lib_content"> 
    <div class="m_index_header"> 
     <a class="message_box" href="/member/user_msg"> 
      <div class="box_bg"></div> <i class="m_icon m_icon_message"></i> </a> 
     <div class="m_index_info"> 
      <a class="portrait_box" href="brand.html"> <img class="portrait_img" src="images/01.jpg" />
       <div class="box_bg"></div> <i class="clear"></i> </a> 
      <div class="portrait_name"> 
       <span class="ellipsis">416148489@qq.com</span> 
     ...
     <div class="m_operate"> 
      <a href="/member/favorites"> 0<br /> <span>收藏的商品</span> </a> 
      <a href="/member/shopfavorites"> 0<br /> <span>收藏的店铺</span> </a> 
      <a href="/member/history"> 11<br /> <span>我的足迹</span> </a> 
     </div> 
     <i class="clear"></i> 
    </div> 
    ...
    <ul class="m_list m_list_top_line bg_white p_index_menu"> 
     <li class="p_menu"> <a href="member_order.html?type=1"> <i class="m_icon"></i><br /> 待付款 <span class="m_smalldots">1</span> </a> <a href="member_order.html?type=2"> <i class="m_icon"></i><br /> 待发货 </a> <a href="member_order.html?type=3"> <i class="m_icon"></i><br /> 待收货 </a> <a href="member_order.html?type=4"> <i class="m_icon"></i><br /> 待评价 </a> 
      <!--			<a href="javascript:void(0);">
				<i class="m_icon"></i><br/>
				退款/售后
				<span class="m_smalldots"></span>
			</a>--> <i class="clear"></i> </li> 
     <li class="link"> <a href="member_order.html?type=0"> <i class="m_icon m_icon_order"></i> 全部订单 
       <div class="right">
         查看全部已购商品 
    ...
    <ul class="m_list m_list_top_line bg_white p_index_menu"> 
     ...
     <li class="link"> <a href="/member/coupon"> <i class="m_icon m_icon_sale"></i> 我的优惠券 
       <div class="right">
         新增0张券
        <!--<span class="m_smalldots"></span>--> 
        <span class="m_arrow"> <i class="rotate45"></i> <i class="rotate135"></i> </span> 
    ...
    <div class="placeholder"></div> 
    <ul class="m_list m_list_top_line bg_white p_index_menu"> 
     <li class="link"> <a href="/member/account"> <i class="m_icon m_icon_user"></i> 账户管理 
       <div class="right"> 
        <span class="m_arrow"> <i class="rotate45"></i> <i class="rotate135"></i> </span> 
       </div> </a> </li> 
    </ul> 
    ...
    <div class="placeholder"></div> 
    <ul class="m_list m_list_top_line bg_white p_index_menu"> 
     <li class="link"> <a href="/help2.0/"> <i class="m_icon m_icon_help"></i> 帮助与反馈 
       <div class="right"> 
        <span class="m_arrow"> <i class="rotate45"></i> <i class="rotate135"></i> </span> 
       </div> </a> </li> 
    </ul> 
   ...
   <div class="m_footer clear"> 
    ...
    <div class="userinfo"> 
     <a class="gray6 ellipsis" href="member_index.html">416148489</a> 
     <span></span> 
     <a class="gray6" href="../login/login.html?act=logout">退出</a>
     <span></span> 
  ...
  <script type="text/javascript" src="js/zip.touch.member2_0.index.v36.js"></script> 
	...
	//微信分享
		...
		if(window.shareData==undefined){
			window.shareData = {
				...
				"imgUrl": "http://ued.paixie.net/template/statics/site_touch/images/public/weixin_paixie.jpg",
				"title": "会员中心-拍鞋网",
				"desc": ""			
			};
		}
