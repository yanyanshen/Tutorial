...
<div class="page-role cart-page cart-trolly-page" id="js-cart-trolly-page">
    <div class="com-title" >
        <div style="float: left;margin-left: 10px;">
            <a title="返回" href="<?php echo U('Mobile/Address/totaladdresslist');?>" style="color: white;">
                &lt;&nbsp;&nbsp;管理收货地址
            </a>
        </div>
    </div>
    ...
    <div class="fixed_price" style="width: 100%;padding: 0;height: 0.8rem;">
        <a href="<?php echo U('Mobile/Address/addAddress');?>" style="width: 100%;display: inline-block;height: 100%;background-color: orangered;color: white;font-size: 16px;text-align: center;line-height: 35px;">添加新地址</a>
    </div>
</div>
<div class="com-footer-area" id="js-com-footer-area">
    ...
    <div class="footer">
        <div class="nav">
            <a class="ellipsis" rel="nofollow" href="http://m.paixie.net/member/" title="个人中心"><span>416148489</span></a> |
            <a rel="nofollow" href="http://m.paixie.netlogin.html?act=logout" title="退出">退出</a> |
            <a rel="nofollow" href="http://m.paixie.netfeed.html" title="用户反馈">用户反馈</a> |
            <a rel="nofollow" href="http://m.paixie.net/help/app.html" title="客户端">客户端</a>
        </div>
        <div class="copy">
            &copy;2007-2015
