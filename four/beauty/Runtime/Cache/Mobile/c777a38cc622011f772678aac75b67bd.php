...
<div class="page-role cart-page cart-trolly-page" id="js-cart-trolly-page">
    ...
    <div class="fixed_price" style="width: 100%;padding: 0;height: 0.8rem;">
        <a href="<?php echo U('Mobile/ManageAddress/addAddress');?>" style="width: 100%;display: inline-block;height: 100%;background-color: orangered;color: white;font-size: 16px;text-align: center;line-height: 35px;">添加新地址</a>
    </div>
</div>
...
<script type="text/javascript">
    $(function(){
        ...
        $('.setdefault').click(function(){
            var index=$(this).index('.setdefault');
                if(index!=a){
                    ...
                    $.post('<?php echo U("Mobile/ManageAddress/setdefault");?>',{id:addid},function(res2){
                        if(res2.status==1){
                            layer.open({
                                content: '设置成功'
                                ,skin: 'msg'
       ...
       $('.delete').click(function(){
           ...
           $.post('<?php echo U("Mobile/ManageAddress/deleteAddress");?>',{id:addid},function(res3){
               if(res3.status==1){
                   layer.open({
                       content: '删除成功'
                       ,skin: 'msg'
        ...
        $('.editor').click(function(){
            addid=$(this).attr('addid');
            location='<?php echo U("Mobile/ManageAddress/editorlist");?>'+'?id='+addid;
        })
    })
</script>