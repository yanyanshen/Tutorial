...
<div class="body">
    <div class="m_header">
        ...
        <h1 class="ellipsis bt_title" style="margin-top:3%"> 点赞排行 </h1>
                ...
                <div class="lists clearfloat">
                    <div class="bottom clearfloat">
                        <?php if(is_array($goodsinfo)): $i = 0; $__LIST__ = $goodsinfo;if( count($__LIST__)==0 ) : echo "$empty" ;else: foreach($__LIST__ as $key=>$data): $mod = ($i % 2 );++$i;?><div class="lie clearfloat">
                                ...
                                <span>
                                  <span style="margin-right: 10px;font-size: 16px;color: black;">点赞数:</span><span style="color: red;"><?php echo ($data["goodscount"]); ?></span>
                                </span>
                                </a>
