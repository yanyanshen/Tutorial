...
<html>
 <head> 
  ...
  <meta content="width=device-width,initial-scale=1.0,maximum-scale=1.0,user-scalable=no" name="viewport" />
     <link rel="stylesheet" type="text/css" href="/beauty/Public/Mobile/list/css/base.css"/>
     <link rel="stylesheet" type="text/css" href="/beauty/Public/Mobile/list/css/page.css"/>
     <link rel="stylesheet" type="text/css" href="/beauty/Public/Mobile/list/css/all.css"/>
     <link rel="stylesheet" type="text/css" href="/beauty/Public/Mobile/list/css/mui.min.css"/>
     <link rel="stylesheet" type="text/css" href="/beauty/Public/Mobile/list/css/loaders.min.css"/>
     <link rel="stylesheet" type="text/css" href="/beauty/Public/Mobile/list/css/loading.css"/>
     <script src="/beauty/Public/Mobile/list/js/jquery.min.1.8.2.js" type="text/javascript"></script>
     ...
     <link rel="stylesheet" href="/beauty/Public/Mobile/css/zip.touch.list2_0.index.v3902355.css" type="text/css" />
  <script type="text/javascript" src="/beauty/Public/Mobile/js/zepto.min.js"></script>



     <script src="/beauty/Public/Mobile/layer_mobile/layer.js" type="text/javascript"></script>
  <style type="text/css">
.m_header,
 ...
 <body> 
  <div class="body"> 
   <div class="m_header"> 
    ...
    <h1 class="ellipsis bt_title" style="margin-top: 3%"> 品牌列表 </h1>
   ...
   <div class="lib_content" id="js_lib_content"> 
    ...
    <div class="m_tab_select">
        <?php if($_SESSION['beauty_']['moren']== 'moren'): ?><a class="orange" href="<?php echo U('Mobile/GoodsList/brandList',array('moren'=>'moren'));?>">默认</a>
            <?php else: ?>
            <a  href="<?php echo U('Mobile/GoodsList/brandList',array('moren'=>'moren'));?>">默认</a><?php endif; ?>
        <?php if($_SESSION['beauty_']['sale']== 'salenum'): ?><a class="orange" href="<?php echo U('Mobile/GoodsList/brandList',array('sale'=>'salenum'));?>">热卖</a>
            <?php else: ?>
            <a  href="<?php echo U('Mobile/GoodsList/brandList',array('sale'=>'salenum'));?>">热卖</a><?php endif; ?>
        <?php if($_SESSION['beauty_']['price1']== 'saleprice'): ?><a class="orange" href="<?php echo U('Mobile/GoodsList/brandList',array('price1'=>'saleprice'));?>" >&nbsp;价格</a>
            <?php else: ?>
            <a href="<?php echo U('Mobile/GoodsList/brandList',array('price1'=>'saleprice'));?>" >&nbsp;价格</a><?php endif; ?>
            ...
            <div class="lists clearfloat">
                <div class="bottom clearfloat" id="insert">
                    <?php if(is_array($goodsList)): $i = 0; $__LIST__ = $goodsList;if( count($__LIST__)==0 ) : echo "$empty" ;else: foreach($__LIST__ as $key=>$data): $mod = ($i % 2 );++$i;?><div class="lie clearfloat">
                            ...
                            <br>
                            <a>
                                <p  style="font-size: 0.25rem;color: #ff8d40">￥<?php echo ($data['saleprice']); ?></p>
                            </a>
                            <br>
                            <a>
                                <span style="width:50%">
...
<script>
  ...
  <script type="text/javascript" src="/beauty/Public/Mobile/js/zip.touch.list2_0.index.v13619.js"></script> 
...
<script>
    $("#js-filter1").click(function(){
        ...
        '<form method="get" id="form1" action="<?php echo U('Mobile/GoodsList/brandList');?>">'+
    ...
    function index(id){
        var id=id?id:1;
        $.get("<?php echo U('GoodsList/brandList');?>",{"p":id},function(res){
            $('#insert').html(res);
        })
    }
</script>