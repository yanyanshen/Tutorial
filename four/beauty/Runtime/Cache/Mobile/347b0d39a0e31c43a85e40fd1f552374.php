 ...
 <body> 
  <div class="body"> 
   <div class="m_header"> 
    ...
    <h1 class="ellipsis bt_title" style="margin-top: 4%"> 女士专区 </h1>
   ...
   <div class="lib_content" id="js_lib_content"> 
    ...
    <div class="m_tab_select">
        <?php if($_SESSION['beauty_']['moren']== 'moren'): ?><a class="orange" href="<?php echo U('Mobile/GoodsList/girl',array('moren'=>'moren'));?>">默认</a>
            <?php else: ?>
            <a  href="<?php echo U('Mobile/GoodsList/girl',array('moren'=>'moren'));?>">默认</a><?php endif; ?>
        <?php if($_SESSION['beauty_']['collect']== 'collectnum'): ?><a class="orange" href="<?php echo U('Mobile/GoodsList/girl',array('collect'=>'collectnum'));?>">热卖</a>
            <?php else: ?>
            <a  href="<?php echo U('Mobile/GoodsList/girl',array('collect'=>'collectnum'));?>">热卖</a><?php endif; ?>
        <?php if($_SESSION['beauty_']['price1']== 'saleprice'): ?><a class="orange" href="<?php echo U('Mobile/GoodsList/girl',array('price1'=>'saleprice'));?>" >&nbsp;价格</a>
            <?php else: ?>
            <a href="<?php echo U('Mobile/GoodsList/girl',array('price1'=>'saleprice'));?>" >&nbsp;价格</a><?php endif; ?>
...
<script>
    $("#js-filter1").click(function(){
        ...
        '<form method="get" id="form1" action="<?php echo U('Mobile/GoodsList/girl');?>">'+
        ...
        '<li style="display:inline-block;width:23%;font-size:0.2rem;margin-left: 1%;margin-top:2%;color: #000000">' +
