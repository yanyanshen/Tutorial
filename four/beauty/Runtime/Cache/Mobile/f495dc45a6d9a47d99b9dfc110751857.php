...
<html>
 <head> 
  ...
  <script>var imgonload =function(){};var urls = window.location.href.split("#");try{ if(/^url:.+/.test(urls[1])){window.location.href=urls[1].slice(4);}}catch(e){}var _hmt = _hmt || [];var PX_HELP_DATA=['416148489@qq.com','i2jioq5184gbv9ts2qudnsgth4',['touch','member2.0','coupon'],'2015/09/15 16:14:32',0]; var DOMIN = {MAIN:"http://www.paixie.net",HELP:"http://help.paixie.net",TUAN:"http://tuan.paixie.net",WAP:"http://wap.paixie.net",UNION:"http://union.weixiaodian.com",VIPSHOP:"http://go.paixie.net"};var DOMINS = {"main":"http://www.paixie.net","tuan":"http://tuan.paixie.net","help":"http://help.paixie.net","union":"http://union.weixiaodian.com","wap":"http://wap.paixie.net","touch":"http://m.paixie.net","vipshop":"http://go.paixie.net","ued":"http://ued.paixie.net"};</script> 
  <link rel="stylesheet" href="/Public/Mobile/css/zip.touch.member2_0.coupon.v3901.css" type="text/css" /> 
 ...
 <body> 
  <div class="body"> 
   <div class="m_header"> 
    ...
    <h1 class="ellipsis bt_title"> 我的红包</h1>
   ...
   <div class="lib_content" id="js_lib_content"> 
    ...
    <div class="placeholder"></div> 
    <div class="m_tab"> 
     <a class="selected"  href="<?php echo U('Mobile/Coupon/index');?>"> 待使用 </a>
     <a class=""  href="<?php echo U('Mobile/Coupon/shixiao');?>"> 已失效 </a>
    </div> 
    <div class="js_textstring"> 
     <div class="m_list" id="coupon_list">
         <table border="0" class="order_tab" style="width:100%;font-size: 16px; text-align:center; margin-bottom:30px;" cellspacing="0" cellpadding="0">
             <tr style="margin-top: 10px;border:1px solid #a9a9a9;height: 50px;border-bottom: 1px solid #000000">
                 <td width="10%">编号</td>
                 <td width="15%">红包产生时间</td>
                 <td width="15%">红包过期时间</td>
                 <td width="15%">红包金额</td>
             </tr>
             <?php if(is_array($list)): $k = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "$empty" ;else: foreach($__LIST__ as $key=>$val): $mod = ($k % 2 );++$k;?><tr style="height: 50px;border: 0;font-size: 0.1rem">
                     <td><?php echo ($k+$firstRow); ?></td>
                     <!--<td><?php echo substr($val['goodsname'],0,24);?></td>-->
                     <td><?php echo date('Y-m-d H:i:s',$val['addtime']);?></td>
                     <td><?php echo date('Y-m-d H:i:s',$val['expirationtime']);?></td>
...
<script>
  ...
  <script type="text/javascript" src="/Public/Mobile/js/zip.touch.member2_0.coupon.v1361.js"></script> 
