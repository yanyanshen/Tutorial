...
<div class="page-role cart-page cart-trolly-page" id="js-cart-trolly-page">
    <div class="com-title" >
        <div style="float: left;margin-left: 10px;">
            <a title="返回" href="<?php echo U('Mobile/MyCart/toaccount');?>" style="color: white;">
                &lt;&nbsp;&nbsp;修改地址
            </a>
        </div>
        <div style="float: right;">
            <a href="<?php echo U('Mobile/MyCart/manageAddress');?>" style="color: white;" class="editor"><span>保存</span></a>
        </div>
            ...
            <div style="margin-left: 10px;">
                ...
                <div style="">
                    ...
                    <div data-toggle="distpicker" style="display: inline-block;margin-top: 8px;">
                        <select data-province="河南省"></select>
                        <select data-city="郑州市"></select>
                        <select data-district="中原区"></select>
                    </div>
                </div>
...
<script type="text/javascript">
    ...
    $('.delete').click(function(){
        ...
        $.post('<?php echo U("Mobile/MyCart/deleteAddress");?>',{id:addid},function(res3){
            if(res3.status==1){
                layer.open({
                    content: '删除成功'
                    ,skin: 'msg'
