...
<div id="Orders" class="Inside_pages  clearfix">
    ...
    <form action="<?php echo U('Home/MyCart/tosubmit1');?>" class="form" method="post" enctype="multipart/form-data" id="formOrder">
        <div class="Orders_style clearfix">
            ...
            <fieldset>
                ...
                <div class="payment">
                    ...
                    <ul>
                        <li><input type="radio" name="radio1" class="radio" disabled= value="支付宝"><img src="/Public/Home/images/logo_alipay.gif" alt="" /></li>
                        <li><input type="radio" name="radio1" class="radio" disabled value="易宝"><img src="/Public/Home/images/logo_yeepay.gif" alt="" /></li>
                        <li><input type="radio" name="radio1" class="radio" disabled value="微信"><img src="/Public/Home/images/logo_weixin.gif" alt="" /></li>
                    </ul>
                </div>
                <!--发票样式-->
                <!--产品列表-->
                        ...
                        <?php if(is_array($orderlist)): $i = 0; $__LIST__ = $orderlist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><table cellpadding="0" cellspacing="0" class="gwc_tb2">
                                ...
                                <tr>
                                    ...
                                    <td class="tb2_td3" style="width: 170px;">
                                        ...
                                        <input type="hidden" name="oid" value="<?php echo ($val["oid"]); ?>"/>
                                        <a href="#"><input type="text" value="<?php echo ($val["goodsname"]); ?>" name="goodsname"/></a>
                                    </td>
                                    <td class="tb1_td4" style="width:110px;text-align: center;">
                                        <input type="text" readonly value="30ml" name="ml" style="width: 60px;"/></td>
                                    <td class="tb1_td4" style="width:110px;text-align: center;">
                                        <input type="text" readonly value="<?php echo ($val["saleprice"]); ?>" name="saleprice" style="width: 60px;"/></td>
                                    ...
                                    <td class="tb1_td6" style="width: 110px;">
                                        <label class="tot" style="color:#ff5500;font-size:14px; font-weight:bold;"><input style="width: 60px;text-align: center;" type="text" class="price" name="price" readonly value="<?php echo ($val["saleprice"]); ?>"/></label>
                                    </td>
                                </tr>
...
<script type="text/javascript">
    ...
    $(".submit_btn").click(function(){
        $.post('<?php echo U("Home/MyCart/tosubmit1");?>',$("#formOrder").serialize(),function(res){
            if(res.status==1){
                layer.msg('兑换成功',{icon:1},function(){
                    location="<?php echo U('Home/Member/Orderform1');?>"
                });
            }else{
                layer.msg('可能购买的人很多，请稍后尝试',{icon:1},function(){
                    location="<?php echo U('Home/Sign/signCity');?>"
                });
            }
        })
    });
