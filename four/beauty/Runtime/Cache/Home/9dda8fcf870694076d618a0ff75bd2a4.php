...
<div class="Product_carousel" id="">
    ...
    <div class="bd">
        <ul>
            <li><a href="#"><div style="background-image: url(/Public/Home/images/png1.jpg);
                 background-repeat:no-repeat; background-position:center; height:437px; background-color:#FFF"></div></a></li>
            <li><a href="#"><div style="background-image: url(/Public/Home/images/png.jpg);
                 background-repeat:no-repeat; background-position:center; height:437px; background-color:#a1e2ff">
...
<!--品牌团购样式-->
 <div class="Inside_pages">
  ...
  <!--品牌-->
    ...
    <div class="title_name"><img src="/Public/Home/images/title_buy_06.png" /></div>
        <ul class="p_sell">
            <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "$empty" ;else: foreach($__LIST__ as $key=>$date): $mod = ($i % 2 );++$i;?><input class="input" type="hidden" restTime="<?php echo ($date['restTime']); ?>"/>
                    <script>
                        ...
                        function timer(a){
                            ...
                            $('.times').eq(a).text('还剩'+dd+'天'+parseInt(24-hh)+'小时'+parseInt(60-mm)+'分'+parseInt(60-ss)+'秒');
                        }
                        setInterval('timer(parseInt("<?php echo ($i-1); ?>"))',1000); // 每隔1S执行一次
                    </script>
                    <li>
                        <div class="img" style="width:160px; height:210px" >
                            <img src="/Uploads/<?php echo ($date["imageurl"]); ?>500_<?php echo ($date["imagename"]); ?>" style="width:160px; height:190px" ></div>
                        <div class="name"><?php echo ($date["goodsname"]); ?></div>
                        <div class="price">
                            <table border="0" style=" color:#888888;" cellspacing="0" cellpadding="0">
                                  <tbody><tr style="font-family:'宋体';">
                                    <td style="width: 33%">原价:￥<?php echo ($date["saleprice"]); ?> </td><td style="width: 30%"><?php echo ($date["salenum"]); ?>人已参加</td>
                                  </tr>
                                  <tr style="color: #ff0000;border: 1px solid red">
                                    <td style="color: #ff0000;border: 1px solid red"></td>
                                  </tr>
                                </tbody>
                            </table>
                        </div>
                        <div class="ch_bg">
                            <span class="ch_txt"><font>团购价￥<?php echo ($date["groupprice"]); ?></font></span>
                            <a href="<?php echo U('BuyBrands/groupdetail',array('gid'=>$date['id'],'tuan'=>$date['groupprice']));?>" class="ch_a">查看</a>
                        </div>
                        <div class="times" style="margin-top: 20px;color: #000000;font-size: 14px"></div>
