...
<div class="i_bg bg_color">
	...
	<div class="m_content" style="margin: 0 auto">
		...
		<div class="m_right">
            <form action="<?php echo U('Member/ebank');?>" method="post">
            <p></p>			
            <div class="mem_tit">
            	<!--&lt;!&ndash;<span class="fr" style="font-size:12px; color:#555555; font-family:'宋体'; margin-top:5px;">&ndash;&gt;</span>-->
                <span style="font-weight: bold;font-size: 25px;margin-left: 450px;color: #F27602">充值</span>
            </div>
			<table border="0" class="ma_tab" style="width:930px; margin-bottom:30px;" cellspacing="0" cellpadding="0">
              <tr>
                  <td class="ma_a" colspan="8" align="right">
                      <a href="<?php echo U('Member/drawcash');?>">提现</a>|<a href="<?php echo U('Member/chargeRecord');?>">充值记录</a>|
