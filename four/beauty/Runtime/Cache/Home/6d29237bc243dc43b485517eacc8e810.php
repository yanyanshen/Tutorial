...
<title>订单确认</title>
    <style>
        ...
        .zfli{border: 1px solid #CCCCCC;padding: 0;width: 100px;height:35px;line-height: 35px;text-align: center;
...
<div class="Process"><img src="/Public/Home/images/Process_img_02.png" /></div>
 <form action="<?php echo U('Home/MyCart/tosubmit');?>" class="form" method="post" enctype="multipart/form-data" id="formOrder">
  <div class="Orders_style clearfix">
     <div class="address clearfix">
       <div class="title">收货人信息</div>
          <div class="adderss_list clearfix">
            ...
            <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><ul class="confirm <?php echo ($val['isdefault']?active:''); ?>">
            ...
            <script type="text/javascript">
                ...
                $(function(){
                    ...
                    $('.delete_btn').click(function(){
                       ...
                       /* a=$(this);*/
                        $.post('<?php echo U("Home/MyCart/deleteAddress");?>',{id:addressid},function(res1){
                            if(res1.status==1){
                    ...
                    $('.setaddress').click(function(){
                        ...
                        $.post('<?php echo U("Home/MyCart/setdefault");?>',{id:addressid},function(res2){
                            if(res2.status){
     ...
     <div class="payment">
      <div class="title_name">支付方式</div>
         <ul style="margin: 0;padding: 0;" id="zf">
             <li id="account" class="zfli zfborder">余额<img src="/Public/Home/images/yue.jpg" alt="" style="width: 40px;height: 35px;margin: 0;padding: 0;"/>
                 <input type="hidden" value="1"/></li>
             <li class="zfli"><img style="width: 100px;height: 35px;" src="/Public/Home/images/logo_alipay.gif" alt="" />
                 <input type="hidden" value="2"/></li>
             <li class="zfli"><img style="width: 100px;height: 35px;" src="/Public/Home/images/logo_yeepay.gif" alt="" />
                 <input type="hidden" value="3"/></li>
             <li class="zfli"><img style="width: 100px;height: 35px;" src="/Public/Home/images/logo_weixin.gif" alt="" />
                 <input type="hidden" value="4"/></li>
             <input type="hidden" name="zhfs1"/>
         </ul>
     </div>
      <!--发票样式-->
     <!--产品列表-->
     ...
     选择已有红包<select name="somename" class="SlectBox" onclick="console.log($(this).val())" onchange="console.log('change is firing')">
         ...
         <div class="shop frm_sty" style="width: 1200px;">
             ...
             <?php if(is_array($orderlist)): $i = 0; $__LIST__ = $orderlist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><input type="hidden" name="gidinfo[<?php echo ($val['gid']); echo ($val["ml"]); ?>]" value="<?php echo ($val["gid"]); ?>"/>
             <table cellpadding="0" cellspacing="0" class="gwc_tb2">
                 ...
                 <tr>
                     ...
                     <td class="tb1_td4" style="width:110px;text-align: center;"><input type="text" readonly value="<?php echo ($val["ml"]); ?>ml" name="ml[<?php echo ($val["gid"]); echo ($val["ml"]); ?>]" style="width: 60px;"/></td>
                     <td class="tb1_td4" style="width:110px;text-align: center;"><input type="text" readonly value="<?php echo ($val["saleprice"]); ?>" name="saleprice" style="width: 60px;"/></td>
                     <td class="tb1_td5" style="width:110px;text-align: center;">
                         <input name="buynum[<?php echo ($val["gid"]); echo ($val["ml"]); ?>]" class="buynum" type="text" value="<?php echo ($val["buynum"]); ?>" readonly style=" width:30px; text-align:center; " />
                         <input type="hidden" value="<?php echo ($val["saleprice"]); ?>" />
                     </td>
                     <td style="width: 120px;text-align: center;"><input style="width: 60px;text-align: center;" readonly name="discount" type="text" value="<?php echo ($val["discount"]); ?>" style="width: 20px;" class="discount"/></td>
                     <td class="tb1_td6" style="width: 110px;">
                         <label class="tot" style="color:#ff5500;font-size:14px; font-weight:bold;"><input style="width: 60px;text-align: center;" type="text" class="price" name="price" readonly value="<?php echo ($val["sumprice"]); ?>"/></label>
                     </td>
                 </tr>
      ...
      <div class="right_direction">
        <ul>
         <li><label>商品总价</label><i>￥</i><input id="totalprice" name="totalprice" value="" style="width: 100px;margin: 8px 10px;"/></li>
         ...
         <li><label>红&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;包</label><i>￥</i><input id="hongbao" name="disprice1" value="0" style="width: 100px;margin-left: 5px;line-height: 10px;margin-top: 6px;"/></li>
         <li class="shiji_price"><label>实&nbsp;&nbsp;付&nbsp;&nbsp;款</label><i>￥</i><input id="trueprice" name="trueprice" value="" style="margin-top: 6px;width: 100px;margin-left: 5px;line-height: 10px;"/></li>
        </ul>   
        <div class="btn">
            ...
            <a href="<?php echo U('Home/MyCart/tocart');?>"  style="background-image:url(/Public/Home/images/Button_img.png);display: inline-block;width: 152px;height: 36px;color:#ffffff;text-align: center;line-height: 36px;margin-left: 10px;" class="return_btn"/>返回购物车</a></div>
...
$('select[name="somename"]').change(function(){
    ...
    $(function(){
        ...
        var disprice=0;
        for(var j=0;j<b;j++){
            disprice+=parseInt($('.gwc_tb2 .discount').eq(j).val());
        }
...
function addLayer(){
    if(flag){
        ...
        layer.open({
            ...
            area:["700px",'600px'],
            content:"<?php echo U('Home/MyCart/layeraddress');?>"
        });
    }
}
</script>
