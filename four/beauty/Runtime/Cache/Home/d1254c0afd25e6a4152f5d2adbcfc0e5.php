...
<div class="i_bg">
    ...
    <div class="content">
        ...
        <form action="<?php echo U('Home/BuyBrands/tobuy',array('man'=>$man,'jian'=>$jian));?>" id="goods" method="post">
        ...
        <div class="pro_des">
            ...
            <div class="des_price">
                本店价格：<b>￥<?php echo ($val["saleprice"]); ?></b><b style="margin-left: 20px;color: #CCCCCC;"><del>￥<?php echo ($val["marketprice"]); ?></del></b><br />
            ...
            <div class="des_share">
                ...
                <div class="d_care" style="position: absolute;top: 340px" >
                    <a id="activity" style="margin-right: 10px;color: red;font-size: 18px">满<?php echo ($man); ?>减<?php echo ($jian); ?></a>
                </div>
