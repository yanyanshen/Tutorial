...
<script>
    ...
    <div class="Inside_pages">
        <div class="footprint_style clearfix">
            <div class="title_name"><em></em>相似产品 <b>MY SIMILAR</b></div>
            <ul>
                <form action="" id="form1" method="get">
                    <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$date): $mod = ($i % 2 );++$i;?><li class="Record_style">
                            <div class="biankuan">
                                ...
                                <div class="name"><a href="#"> <?php echo (mb_substr($date["goodsname"],0,18,utf8)); ?></a></div>
                                <div class="Price">
