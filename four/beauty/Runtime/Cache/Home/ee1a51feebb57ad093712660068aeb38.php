...
<div class="Product_carousel" id="">
    ...
    <div class="bd">
        <ul>
            <li><a href="#"><div style="background-image: url(/Public/Home/AD_img/AD-111.jpg);
            ...
            <li><a href="#"><div style="background-image: url(/Public/Home/images/png1.jpg); background-repeat:no-repeat; background-position:center; height:437px; background-color:#FEF4E8"></div></a></li>
        </ul>
    </div>
...
<!--品牌团购样式-->
 <div class="Inside_pages">
    ...
    <div class="title_name" style="text-align: center"><h1>品牌商品</h1></div>
        <ul class="p_sell">

            <?php if(is_array($brandGoods)): $i = 0; $__LIST__ = $brandGoods;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$date): $mod = ($i % 2 );++$i;?><li>
                        <div class="img"><img src="/Uploads/<?php echo ($date["imageurl"]); echo ($date["imagename"]); ?>" width="160" height="140"></div>
                        ...
                        <div class="price">
                            <table border="0" style="width:100%; color:#888888;" cellspacing="0" cellpadding="0">
                                  ...
                                  <tr>
                                    <td style="text-decoration:line-through;">￥<?php echo ($date["marketprice"]); ?></td>
                                    <td style="color: #ff0000"><?php echo ($date["rules"]); ?></td>
                                  </tr>
                                </tbody>
                            </table>
                        </div>
                        <div class="ch_bg">
                            <span class="ch_txt">￥<font><?php echo ($date["saleprice"]); ?></font></span>
                            <a href="<?php echo U('Order/goodsdetail',array('gid'=>$date['id']));?>" class="ch_a">查看</a>
                        </div>
    ...
    <div class="sell_style clearfix">
     <div class="advisory sell">
      <div class="left_sell">
      <a href="#">
      <img src="/Public/Home/images/tm_1.png"></a>
      </div>
     ...
     <div class="left_sell">
      <a href="#">
      <img src="/Public/Home/images/tm_2.png"></a>
      </div>
      <div class="right_sell">
       	 享受VIP专属特权
       <br>
