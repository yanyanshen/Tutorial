        ...
        <div class="p_Section clearfix">
            ...
            <div class="Section_info clearfix">
                <div class="pro_ad_slide">
                    ...
                    <div class="bd">
                        <ul>
                            <?php if(is_array($advertise2)): $i = 0; $__LIST__ = $advertise2;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val2): $mod = ($i % 2 );++$i;?><li><a href="#"><img class='lazy'  data-original="/Uploads/Advertises/<?php echo ($val2["picurl"]); echo ($val2["picname"]); ?>" src="/Public/Home/images/loading.gif" width="598" height="449"/></a></li><?php endforeach; endif; else: echo "" ;endif; ?>
