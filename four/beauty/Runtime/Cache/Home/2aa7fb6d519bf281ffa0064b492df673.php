...
<div id="page">
    <div id="content">
        <form class="tb-rate-pt-l" id="rateListForm" name="addfeedback" target="_top" novalidate  method="post" action="<?php echo U('Home/Member/zuijiasuccess');?>">
                                    ...
                                    <div class="rate-msg-box">
                                        ...
                                        <div class="bd">
                                            <div class="textinput ph-hide">
                                                ...
                                                <textarea name="<?php echo ($v["id"]); echo ($v["ml"]); ?>[content]" maxlength="500" aria-labelby="label-ti-2472159552941165" placeholder="追加评价再送5积分哦" class="rate-msg"></textarea>
            ...
            <div class="submitbox">
                <a class="btn" style="width: 120px;background-color: red;color:white;text-decoration:none;cursor:pointer;height: 25px;border-radius: 5px;display: inline-block;line-height: 25px;text-align: center;">发表追加</a>
            </div>
        </form>
    </div>
</div>
        ...
        $('.btn').click(function(){
            if( $('.tabbed-box-bd textarea').val().length<10){
                ...
                $('#rateListForm').ajaxSubmit(function(res){
                    if(res.status==1){
                        layer.msg('追加成功',{time:500},function(){
