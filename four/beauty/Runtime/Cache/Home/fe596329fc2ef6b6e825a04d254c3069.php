...
<script>
    $(function(){
        $('.btn').click(function() {
            $.post('<?php echo U("Home/Feedback/index");?>',$('#form1').serialize(), function (res) {
                layer.msg(res,{time:2000},function(){
                    location='<?php echo U("Home/Feedback/index");?>';
                })
            })
        })
    })
...
<div class="Inside_pages">
  <div class="feedback_style">
    ...
    <form id="form1" name="form1" method="post" action="<?php echo U('Home/Feedback/index');?>">
    <div class="clearfix">
     <div class="select">
      ...
      <div class="title_name"><b>*</b>您对网站总体满意度如何？</div>
         ...
         <table width="100%">
           <tr>
             <td><label>
               <input type="radio" name="RadioGroup2" value="1" id="RadioGroup1_0" />
               非常满意</label></td>
           </tr>
           <tr>
             <td><label>
               <input type="radio" name="RadioGroup2" value="2" id="RadioGroup1_1" />
               满意</label></td>
           </tr>
           <tr>
             <td><label>
               <input type="radio" name="RadioGroup2" value="3" id="RadioGroup1_2" />
               一般</label></td>
           </tr>
           <tr>
             <td><label>
               <input type="radio" name="RadioGroup2" value="4" id="RadioGroup1_3" />
               不满意</label></td>
           </tr>
           <tr>
             <td><label>
               <input type="radio" name="RadioGroup2" value="5" id="RadioGroup1_4" />
               非常不满意</label></td>
           </tr>
         </table>
     </div>
      ...
      <div class="title_name"><b>*</b>快速留言方式</div>
         <table width="100%">
           <tr>
             <td><label>
               <input type="radio" name="RadioGroup3" value="1" id="RadioGroup1_0" />
               非常满意</label></td>
           </tr>
           <tr>
             <td><label>
           ...
           <tr>
             <td><label>
               <input type="radio" name="RadioGroup3" value="3" id="RadioGroup1_2" />
               一般</label></td>
           </tr>
           <tr>
             <td><label>
               <input type="radio" name="RadioGroup3" value="4" id="RadioGroup1_3" />
               投诉</label></td>
           </tr>
           <tr>
             <td><label>
               <input type="radio" name="RadioGroup3" value="5" id="RadioGroup1_4" />
               举报</label></td>
           </tr>
         </table>
  ...
  <div class="select">
      <div class="title_name"><b>*</b>对本站的服务</div>
         <table width="100%">
           <tr>
             <td><label>
               <input type="radio" name="RadioGroup4" value="1" id="RadioGroup1_0" />
               非常满意</label></td>
           </tr>
           <tr>
             <td><label>
           ...
           <tr>
             <td><label>
               <input type="radio" name="RadioGroup4" value="3" id="RadioGroup1_2" />
               一般</label></td>
           </tr>
           <tr>
             <td><label>
               <input type="radio" name="RadioGroup4" value="4" id="RadioGroup1_3" />
               投诉</label></td>
           </tr>
           <tr>
             <td><label>
               <input type="radio" name="RadioGroup4" value="5" id="RadioGroup1_4" />
               举报</label></td>
           </tr>
         </table>      
     </div>
     ...
     <div class="feedtext">
      ...
      <div class="add_text"><textarea name="idea" cols="" rows=""></textarea></div>
     </div>
     <div class="contact_details clearfix">
       <div class="title_name"><b>*</b>为方便联系请填写联系方式</div>
       <div class="contact"><label>联系人</label><input name="username" type="text"  class="add_xinxi"/></div>
       <div class="contact"><label>联系电话</label><input name="mobile" type="text"  class="add_xinxi"/></div>
     </div>
     <div><input type="button" value="提交"  class="btn"/></div>
     </form>
  </div>
