  ...
  <div class="Orders_style clearfix">
     ...
     选择已有红包<select name="somename" class="SlectBox" onclick="console.log($(this).val())" onchange="console.log('change is firing')">
         ...
         <div class="shop frm_sty" style="width: 1200px;">
             ...
             <?php if(is_array($orderlist)): $i = 0; $__LIST__ = $orderlist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><table cellpadding="0" cellspacing="0" class="gwc_tb2">
                 ...
                 <tr>
                     ...
                     <td class="tb1_td4" style="width:110px;text-align: center;"><input type="text" readonly value="<?php echo ($val["ml"]); ?>" name="ml" style="width: 60px;"/></td>
                     ...
                     <td class="tb1_td5" style="width:110px;text-align: center;">
                         <input name="buynum" class="buynum" type="text" value="<?php echo ($val["buynum"]); ?>" readonly style=" width:30px; text-align:center; " />
                         <input type="hidden" value="<?php echo ($val["saleprice"]); ?>" />
                     </td>
                     <td style="width: 120px;text-align: center;"><input  readonly name="discount" type="text" value="<?php echo ($val["discount"]); ?>" style="width: 20px;" class="discount"/></td>
      ...
      <div class="right_direction">
        ...
        <div class="btn">
           <!-- <input type="submit" value="提交订单" class="submit_btn"/>-->
...
$('select[name="somename"]').change(function(){
    ...
    $(function(){
        ...
        var b=$('.gwc_tb2 input[name="discount"]').length;
        var disprice=0;
        for(var j=0;j<b;j++){
