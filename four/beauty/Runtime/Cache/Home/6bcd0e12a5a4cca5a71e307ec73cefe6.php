...
<script>
    ...
    <div class="Product_carousel" id="">
        ...
        <div class="bd">
            <ul style="width: 1903px;margin: 0 auto;float: left;">
                <li><a href="#"><div style="background-image: url(/Public/Home/images/banner/png1.jpg); background-repeat:no-repeat; background-position:center;height:437px; background-color:#FFF"></div></a></li>
                <li><a href="#"><div style="background-image: url(/Public/Home/AD_img/01.jpg);margin: 0 auto; background-repeat:no-repeat; background-position:center; height:437px;width: 1200px; background-color:#a1e2ff"></div></a></li>
            </ul>
        </div>
        ...
        <div class="footprint_style clearfix">
            ...
            <ul>
                <form action="" id="form1" method="get">
                    <?php if(is_array($footInfo)): $i = 0; $__LIST__ = $footInfo;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$date): $mod = ($i % 2 );++$i;?><li class="Record_style">
                            <div class="biankuan">
                                <div class="img_link center">
                                    <a href="<?php echo U('Home/Order/goodsdetail',array('gid'=>$date['gid']));?>">
                                        <img src="/Uploads/<?php echo ($date["imageurl"]); echo ($date["imagename"]); ?>" />
                                    </a>
                                </div>
                                <span  style="width:100px;height:30px;line-height: 30px;margin-left: 150px;
                                position:absolute;cursor: pointer;margin-top: 25px;color: #808080;font-size: 14px">
                                    收藏量：<span style="color: orangered;"><?php echo ($date["collectnum"]); ?></span>次
                                </span>
                                <div class="name">
                                    <a href="<?php echo U('Home/Order/goodsdetail',array('gid'=>$date['gid']));?>">
                                    <?php echo (mb_substr($date["goodsname"],0,18,utf8)); ?>
                                    </a>
                                </div>
                                <div class="Price">
                                    <b>￥</b><?php echo ($date["saleprice"]); ?>
                                        <a href="javascript:;" class="deletefoot" gid="<?php echo ($date["gid"]); ?>"  style="width:100px;height:30px;position: absolute;cursor: pointer;margin-left: 30px;color: #808080;font-size: 15px">删除</a>
                                        <a href="<?php echo U('Footprint/similar',array('cid'=>$date['cid']));?>"  class="similar" style="width:100px;height:30px;position: absolute;cursor: pointer;margin-left: 90px;color: #808080;font-size: 15px;">找相似</a>
                                </div>
                                <div class="logo"><a href="<?php echo U('Home/Order/goodsdetail',array('gid'=>$date['gid']));?>">
                                    <img src="/Upload/logo<?php echo ($date["blogopath"]); echo ($date["blogoname"]); ?>"  width="150" height="90" /></a></div>
                            </div>
...
<script type="text/javascript">
    ...
    $(function(){
        $(".deletefoot").click(function(){
            var a=$(this);
            var gid=$(this).attr('gid');
            $.get("<?php echo U('Footprint/deletefoot');?>?gid="+gid,function(res){
                if(res.status==1){
                    a.parents('li').hide();
                }
            })
