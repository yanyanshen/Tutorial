...
<div class="i_bg bg_color">
	...
	<div class="m_content" style="margin:0 auto">
		...
		<div class="m_right">
			...
			<div class="mem_tit">
            	本站会员<span class="m_num">共 <?php echo ($userNum); ?>人</span>
            </div>
            <ul class="members">

            	<li>
                	<div class="nums">（<?php echo ($order1); ?>）</div>
                    <div class="m_type"><a href="#"><span style="color: #4C4C4C"><?php echo ($myorder==1?'我是':''); ?></span>普通会员</a> </div>
                </li>
                <li>
                	<div class="nums">（<?php echo ($order2); ?>）</div>
                    <div class="m_type"><a href="#"><span style="color: #4C4C4C"><?php echo ($myorder==2?'我是':''); ?></span>高级会员</a></div>
                </li>
                <li>
                	<div class="nums"  style="text-align: center;margin: 0 auto;">（<?php echo ($order3); ?>）</div>
                    <div class="m_type"><a href="#"><span style="color: #4C4C4C"><?php echo ($myorder==3?'我是':''); ?></span>黄金会员</a></div>
                </li>
            </ul>
        </div>
    </div>
