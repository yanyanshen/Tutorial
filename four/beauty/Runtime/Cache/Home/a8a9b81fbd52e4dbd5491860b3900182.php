    ...
    <div class="m_content" style="margin:0 auto">
        <div class="m_left">
            ...
            <div class="left_m">
                ...
                <ul>
                    <li><a href="<?php echo U('Home/Member/MemberCentre');?>" class="now">用户信息</a></li>
                    <li><a href="<?php echo U('Home/Member/showCollect');?>">我的收藏</a></li>
                    <li><a href="User_Comment.html">我的评论</a></li>
                </ul>
            </div>
            <div class="left_m">
        ...
        <div class="m_right">
            <div class="m_des">
                <table border="0" style="width:870px; line-height:22px;" cellspacing="0" cellpadding="0">
                    <tr valign="top">
                        <td width="115"><img src="/UserImg/photo<?php echo ($savepath); echo ($savename); ?>" width="90" height="90" /></td>
                        <td>
                            <div class="m_user"><?php echo (session('mname')); ?></div>
                            <p>
                                等级：<?php echo ($order); ?> <br />
                                <font color="#ff4e00">您当前积分<?php echo ($score); ?>!<?php if(($score > 1000) or ($score == 1000)): else: ?> 还差<?php endif; ?>
                                    <?php if(($score < 500) ): echo ($var1); ?> 积分达到高级会员
                                        <?php elseif(($score < 1000) and ($score > 500) or ($score == 500)): ?> <?php echo ($var); ?>积分达到黄金会员
                                        <?php elseif(($score > 1000) or ($score == 1000)): ?> 您已是最高等级<?php endif; ?> </font><br />
                                上一次登录时间: <?php echo (date('Y-m-d H:i:s',$lastTime)); ?><br />
            ...
            <table border="0" class="mon_tab" style="width:870px; margin-bottom:20px;" cellspacing="0" cellpadding="0">
                <tr>
                    <td width="33%">用户等级：<span style="color:#555555;"><?php echo ($order); ?></span></td>
                    <td width="33%">消费金额：<span>￥<?php echo ($money?$money:0); ?></span></td>
                </tr>
                <tr>
                    <td>账户余额：<span>￥<?php echo ($balance?$balance:0); ?>元</span></td></td>
                    <td>红包个数：<span style="color:#555555;"><?php echo ($discount?$discount:0); ?>个</span></td></td>
                </tr>
                <tr>
                    <td colspan="3">订单提醒：
                        <font style="font-family:'宋体';">待付款(<span><?php echo ($waitOrder); ?></span>) &nbsp; &nbsp; &nbsp; &nbsp; 待收货(<span><?php echo ($forGoods); ?></span>) &nbsp; &nbsp; &nbsp; &nbsp; 待评论(<span><?php echo ($waitComment); ?></span>)</font>
                    </td>
                </tr>
            </table>
            ...
            <table border="0" class="mon_tab" style="width:870px; margin-bottom:20px;" cellspacing="0" cellpadding="0">
                <tr>
                    <td width="40%">用户ID：<span style="color:#555555;"><?php echo (session('mname')); ?></span></td>

                </tr>
                <tr>

                    <td>邮&nbsp; &nbsp; 箱：<span style="color:#555555;"><?php echo ($email); ?></span></td>
                </tr>
                <tr>

                    <td>注册时间：<span style="color:#555555;"><?php echo (date('Y-m-d H:i:s',$regTime)); ?></span></td>
                </tr>
            </table>
