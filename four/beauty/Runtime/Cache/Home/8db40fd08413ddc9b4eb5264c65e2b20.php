    ...
    <div class="feedback_style">
        <div class="Introduce">
            ...
            <div class="clearfix" style="text-align: center;">
                    <span style="background-color:orangered;color:white;border-radius:5px;width:180px;text-align: center;font-size:20px;line-height: 30px;height: 30px;display: inline-block;margin-bottom: 20px;"><?php echo ($newinfo[0]['newtitle']); ?></span>
                    <textarea name="" id="" style="width: 100%;height: 600px;" readonly><?php echo ($newinfo[0]['newcontent']); ?></textarea>
