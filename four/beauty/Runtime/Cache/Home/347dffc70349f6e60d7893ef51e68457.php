...
<div class="i_bg bg_color">
	...
	<div class="m_content" style="margin: 0 auto">
   		<div class="m_left">
            ...
            <div class="left_m">
                ...
                <ul>
                    ...
                    <li><a class="now" href="<?php echo U('Home/Member/showCollect');?>">我的收藏</a></li>
		...
		<div class="m_right">
            <p></p>
            <div class="mem_tit">
            	<span class="fr" style="font-size:12px; color:#55555; font-family:'宋体'; margin-top:5px;">共发现<?php echo ($count); ?>条记录</span>我的收藏
            </div>
              ...
              <tr>                                                                                                                                       
                ...
                <form action="" id="form1" method="get">
                    <?php if(is_array($collectList)): $i = 0; $__LIST__ = $collectList;if( count($__LIST__)==0 ) : echo "$empty" ;else: foreach($__LIST__ as $key=>$date): $mod = ($i % 2 );++$i;?><tr>
                        <td style="font-family:'宋体';">
                            <div class="sm_img" style="width: 150px;height: 100px">
                                <a href="<?php echo U('Order/goodsdetail',array('gid'=>$date['gid']));?>">
                                    <img style="width: 150px;height: 120px" src="/Uploads/<?php echo ($date["imageurl"]); echo ($date["imagename"]); ?>"  />
                                </a>
                            </div>
                            <a href="<?php echo U('Order/goodsdetail',array('gid'=>$date['gid']));?>"><?php echo (mb_substr($date["goodsname"],0,20,utf8)); ?>...</a>
                        </td>
                        <td align="center"><?php echo ($date['saleprice']); ?></td>
                        <td align="center"><a href="<?php echo U('Home/MyCart/mycart');?>" style="color:#ff4e00;"></a>&nbsp; &nbsp;
                            <a href="javascript:;" class="deleteCollect" gid="<?php echo ($date["gid"]); ?>">删除</a></td>
...
<script>
    ...
    $(function(){
        $(".deleteCollect").click(function(){
            var a=$(this);
            var gid=$(this).attr('gid');
            $.get("<?php echo U('Member/deleteCollect');?>?gid="+gid,function(res){
