...
<head>
    ...
    <script>
        $(function(){
            $('.del').click(function(){
                var id=$(this).attr('id');
                $.post("<?php echo U('Member/delPacket');?>",{id:id},function(res){
                    if(res.status==1){
                        layer.msg('红包删除成功',{icon:6,time:3000},function(){
                            location="<?php echo U('Member/packet');?>";
                        })
                    }else{
   		...
   		<div class="m_left">
            ...
            <div class="left_m">
                ...
                <ul>
                    ...
                    <li><a href="<?php echo U('Member/packet');?>" class="now">我的红包</a></li>
              ...
              <tr>
                ...
                <td width="15%">红包过期时间</td>
                  ...
                  <td width="15%">操作</td>
                    ...
                    <?php if(is_array($list)): $k = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "没有查到数据" ;else: foreach($__LIST__ as $key=>$val): $mod = ($k % 2 );++$k;?><tr>
                        ...
                        <?php if($val['status'] == 0): ?><td>已过期</td>
                            <?php elseif($val['status'] == 1): ?>
                            <td>待使用</td>
                            <?php else: ?>
                            <td>已使用</td><?php endif; ?>
                        <td><a href="#" class="del" id="<?php echo ($val["id"]); ?>">删除</a></td>
                    </tr><?php endforeach; endif; else: echo "没有查到数据" ;endif; ?>
