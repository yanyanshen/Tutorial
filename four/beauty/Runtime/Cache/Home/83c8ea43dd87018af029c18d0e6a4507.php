    ...
    <div class="m_content" style="margin: 0 auto">
        ...
        <div class="m_right">
            ...
            <div class="mem_tit">
                ...
                <span style="font-weight: bold;font-size: 25px;margin-left: 430px;color: #F27602">充值记录</span>
            </div>
            <table border="0" class="ma_tab" style="width:930px; text-align:center; margin-bottom:30px;margin-top: 20px" cellspacing="0" cellpadding="0">
                <tr>
                    <td class="ma_a" colspan="8" align="right">
                        <a href="<?php echo U('Member/recharge');?>">充值</a>|<a href="<?php echo U('Member/drawcash');?>">提现</a>|
                        <a href="<?php echo U('Member/cashRecord');?>">提现记录</a>|<a href="<?php echo U('Member/tradeRecord');?>">消费记录</a>
                    </td>
                </tr>
                <tr>
                    <td width="65">编号</td>
                    <td width="200">充值时间</td>
                    <td width="155">充值额度</td>
                    <td width="155">充值总额</td>
                </tr>
