    ...
    <script>
        $(function(){
            $('.operate').click(function(){
                ...
                $.post("<?php echo U('Member/operate');?>",{mid:mid},function(res){
                    if(res.status==1){
			...
			<table  class="ma_tab" border="0" style="width:930px; text-align:center; margin-bottom:30px;border: 1px solid red" cellspacing="0" cellpadding="0">
                <tr>
              	<td class="ma_a" colspan="8" align="right">
                    <a href="<?php echo U('Member/recharge');?>">充值</a>|<a href="<?php echo U('Member/drawcash');?>">提现</a>|
              ...
              <tr>
                ...
                <td class="list"><?php echo ($rechargesum); ?></td>
                  <td class="list"><?php echo ($cashsum); ?></td>
                  <td class="list"><?php echo ($tradesum); ?></td>
                <td class="list"><?php echo ($balance); ?></td>
                <td><?php echo ($status==0?'冻结':'激活'); ?></td>
                <td><a href="#" class="operate" id="<?php echo ($mid); ?>"><?php echo ($status==0?'激活':'冻结'); ?></a></td>
              </tr>
              <tr>
                <td colspan="8" align="right">您当前的可用资金为：<span class="list">￥ <?php echo ($balance); ?></span></td>
              </tr>
                </volist>
