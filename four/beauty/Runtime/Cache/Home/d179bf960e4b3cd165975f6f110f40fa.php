...
<head>
    ...
    <style type="text/css">
        #test {
            ...
            width: 400px;height: 95px;color: red;line-height: 30px ;
            word-spacing: 5px;
            top: 0px;left: 750px;
            overflow:hidden;
            padding: 5px;
...
<script>
    ...
    <div class="Inside_pages clearfix">
        ...
        border:dotted #a9a9a9 1px;width: 300px;height: 50px;opacity: 0.7;color: black;line-height: 50px ">
                欢迎来到黄金会员专享</div>
            <div id="test">
                <div id="test1">
                    欢迎来到黄金会员专享！！！<br>
            ...
            <div class="list" style="margin-top: 60px;">
                <ul class="list_style">
                    <?php if(is_array($goodsInfo)): $i = 0; $__LIST__ = $goodsInfo;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$date): $mod = ($i % 2 );++$i;?><li class="p_info_u">
                            <div class="p_info_content">
                                <a href="<?php echo U('Huiyuan/goodsdetail',array('gid'=>$date['id']));?>" class="p_img"><img style="width: 230px;height:220px" src="/Uploads/<?php echo ($date["imageurl"]); ?>300_<?php echo ($date["imagename"]); ?>"></a>
                                <a href="<?php echo U('Huiyuan/goodsdetail',array('gid'=>$date['id']));?>" class="name"><?php echo ($date["goodsname"]); ?></a>
                            </div>
                            <div class="Numeral"><span class="price">黄金会员价：<i>￥</i><?php echo ($date["saleprice"]); ?></span><span class="Sales">销量<i><?php echo ($date["salenum"]); ?></i>件</span></div>
                            <div class="Brands_logo"><a href="<?php echo U('BrandGoods/showBrand',array('bid'=>$date['bid']));?>"><img src="/Upload/logo<?php echo ($date["blogopath"]); echo ($date["blogoname"]); ?>"  width="130" height="70"/></a></div>
