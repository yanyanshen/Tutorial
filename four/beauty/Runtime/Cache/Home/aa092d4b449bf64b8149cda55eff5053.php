 ...
 <!--产品列表-->
  ...
  <div class="Inside_pages clearfix">
   ...
   <div class="must_list like_p">
       <div style="text-align: center;font-size: 25px;font-style: italic;opacity: 0.7;color: red;line-height: 50px ">
           女士专区</div>
       <div class="list">
          <ul class="list_style">
              <?php if(is_array($goodsInfo)): $i = 0; $__LIST__ = $goodsInfo;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$date): $mod = ($i % 2 );++$i;?><li class="p_info_u">
                    ...
                    <a href="<?php echo U('Order/goodsdetail',array('gid'=>$date['id']));?>" class="p_img"><img style="width: 230px;height:220px" src="/Uploads/<?php echo ($date["imageurl"]); ?>300_<?php echo ($date["imagename"]); ?>"></a>
                    <a href="<?php echo U('Order/goodsdetail',array('gid'=>$date['id']));?>" class="name"><?php echo ($date["goodsname"]); ?></a>
                    </div>
                    ...
                    <div class="Brands_logo"><a href="<?php echo U('BrandGoods/showBrand',array('bid'=>$date['bid']));?>"><img src="/Upload/logo<?php echo ($date["blogopath"]); echo ($date["blogoname"]); ?>"  width="130"/></a></div>
