...
KE.util = {
    ...
    loadStyle : function(path) {
        var link = KE.$$('link');
        link.setAttribute('type', 'text/style');
    ...
    getFullHtml : function(id, tagLineMode) {
        ...
        if (tagLineMode) {
            html += '<link href="' + KE.g[id].skinsPath + 'editor.style" rel="stylesheet" type="text/style" />';
        }
        if (KE.g[id].cssPath) {
            html += '<link href="' + KE.g[id].cssPath + '" rel="stylesheet" type="text/style" />';
        }
        html += '</head>';
