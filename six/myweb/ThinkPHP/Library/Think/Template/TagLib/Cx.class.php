...
class Cx extends TagLib {
    ...
    protected $tags   =  array(
        ...
        'import'    =>  array('attr'=>'file,href,type,value,basepath','close'=>0,'alias'=>'load,style,js'),
     ...
     * <import file="Css.Base" type="style" />
     * @access public
     * @param array $tag 标签属性
     * @param string $content  标签内容
        ...
        if($isFile) {
            ...
            foreach ($array as $val){
                ...
                case 'js':
                    ...
                    break;
                case 'style':
                    $parseStr .= '<link rel="stylesheet" type="text/style" href="'.$val.'" />';
                    break;
                case 'php':
            ...
            foreach ($array as $val){
                ...
                case 'js':
                    ...
                    break;
                case 'style':
                    $parseStr .= '<link rel="stylesheet" type="text/style" href="'.$basepath.'/'.str_replace(array('.','#'), array('/','.'),$val).'.style'.($version?'?'.$version:'').'" />';
                    break;
                case 'php':
    ...
    // import别名使用 导入css文件 <style file="__PUBLIC__/Css/Base.style" />
    public function _css($tag,$content) {
        return $this->_import($tag,$content,true,'style');
    }
