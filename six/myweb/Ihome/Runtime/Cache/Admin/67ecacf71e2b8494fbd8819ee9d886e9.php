                ...
                <div id="tab2" class="tabson">
                    <form action="<?php echo U('Admin/Goods/search');?>" method="get">
                        <ul class="seachform">
                            ...
                            <ul class="toolbar1">
                                <li class="click"><a href="<?php echo U('Admin/Goods/addGoods');?>"><span><img src="/Public/Admin/images/t01.png"/></span>添加</a></li>
                            </ul>
                        </ul>
                    </form>
                    <table class="tablelist">
                        ...
                        <tbody>
                            <?php if(is_array($goodslist)): $k = 0; $__LIST__ = $goodslist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$value): $mod = ($k % 2 );++$k;?><tr>
                                ...
                                <td><a href="javascript:det(<?php echo ($value["gid"]); ?>);" class="mytab"><img src="/Public/Upload/Goodspic/thumb_80_<?php echo ($value["pic"]); ?>" alt=""/></a></td>
    ...
    <script type="text/javascript">
        ...
        function det(gid){
            layer.open({
                ...
                shade: 0.8,
                area: ['1200px', '50%'],
                content: '/index.php/Admin/Goods/det/gid/'+gid
            });
        }
    </script>
</html>