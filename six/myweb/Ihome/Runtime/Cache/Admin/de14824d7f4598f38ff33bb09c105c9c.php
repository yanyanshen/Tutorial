...
<body style="background:#f0f9fd;">
    ...
    <dl class="leftmenu">
        <dd>
            ...
            <ul class="menuson">       
                 <li class="active">
                    <div class="header">
                        <cite></cite>
                        <a href="<?php echo u('Notice/notice','Admin');?>" target="rightFrame">后台首页</a>
                        <i></i>
                    </div>
                 </li>
                <li>
                    <div class="header">
                        <cite></cite>
                        <a href="<?php echo u('Notice/form','Admin');?>" target="rightFrame">发布公告</a>
                        <i></i>
                    </div>
                </li>
                 <li>
        ...
        <!--<dd>-->
            ...
            <!--<ul class="menuson">-->
                <!--<li class="active">-->
                    <!--<div class="header">-->
                        <!--<cite></cite>-->
                        <!--<a href="<?php echo U('Admin/Lunbo/addLunBo','');?>" target="rightFrame">添加广告</a>-->
                        <!--<i></i>-->
                    <!--</div>-->
                <!--</li>-->
                <!--<li>-->
                    <!--<div class="header">-->
                        <!--<cite></cite>-->
                        <!--<a href="<?php echo U('Admin/Lunbo/lunBolist');?>" target="rightFrame">轮播列表</a>-->
                        <!--<i></i>-->
                    <!--</div>-->
                <!--</li>-->
            <!--</ul>-->
        ...
        <dd>
            ...
            <ul class="menuson">
                ...
                <li class="active">
                    <div class="header">
                        <cite></cite>
                        <a href="<?php echo u('Member/MemberAdd','Admin');?>" target="rightFrame">添加会员</a>
                        <i></i>
                    </div>
                </li>
            </ul>    
        ...
        <dd>
            <div class="title">
                <span><img src="/Public/Admin/images/leftico01.png" /></span>友情链接
            </div>
            <ul class="menuson">
                <li>
                    <div class="header">
                        <cite></cite>
                        <a href="<?php echo u('Link/linkList','Admin');?>" target="rightFrame">链接列表</a>
                        <i></i>
                    </div>
                </li>
                <li class="active">
                    <div class="header">
                        <cite></cite>
                        <a href="<?php echo u('Link/addLink','Admin');?>" target="rightFrame">添加链接</a>
                        <i></i>
                    </div>
                </li>
            </ul>
