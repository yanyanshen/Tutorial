        ...
        <div class="formbody">
            <div id="usual1" class="usual">
                <div id="tab1" class="tabson">
                    <form action="<?php echo U('Admin/Goods/addGoods');?>" enctype="multipart/form-data" method="post" id="goodsInfo">
                        <ul class="forminfo">
                            ...
                            <li><label>商品名称<b>*</b></label><input name="goodsname" type="text" class="dfinput" value="" style="width:345px;"/></li>
                            <li><label>商品颜色<b>*</b></label><input name="color" type="text" class="dfinput" value="" style="width:345px;"/></li>
                            <li><label>商品数量<b>*</b></label><input name="num" type="text" class="dfinput" value=""  style="width:345px;"/></li>
                            <li><label>市场价格<b>*</b></label><input name="marketprice" type="text" class="dfinput" value=""  style="width:345px;"/></li>
                            <li><label>商城价格<b>*</b></label><input name="price" type="text" class="dfinput" value=""  style="width:345px;"/></li>
