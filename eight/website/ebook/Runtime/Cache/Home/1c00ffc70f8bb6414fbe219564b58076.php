...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
    ...
    <script type="text/javascript" src="/Public/Home/js/region_select.js"></script>
		...
		<div class="m_right">
			...
			<div class="address">
            	<table border="0" class="add_t" align="center" style="width:98%; margin:10px auto;" cellspacing="0" cellpadding="0">
                    <tr>
                        <td align="right" width="80">收货用户：</td>
                        <td><?php echo ($username); ?></td>
                    </tr>
                    <tr>
                        <td align="right" width="80">用户昵称：</td>
                    ...
                    <tr>
                        <td align="right" width="80">联系邮箱：</td>
                        <td><?php echo ($email); ?></td>
                    </tr>
                    <tr>
                        <td align="right" width="80">详细地址：</td>
                        <td><?php echo ($address); ?></td>
                    </tr>
                </table>
            </div>
            <div class="mem_tit">修改地址</div>
            <form action="<?php echo U('Home/Member/member_address');?>" method="post">
                <table border="0" class="add_tab" style="width:930px;"  cellspacing="0" cellpadding="0">
                    <tr>
                        <td align="left">
                            <div class="control-group">
                                <label class="control-label" for="location_p" style="font-size: 15px;font-weight: bold">选择地址</label>
                                <div class="controls">
                ...
                <p align="right">
                    <a><input type="submit"  value="确认修改" class="add_b"/></a>
                </p>
            </form>
        </div>
    </div>
