...
<div class="i_bg">
    <div class="m_content">
        <form action="<?php echo U('Home/BuyCar/buyCar');?>">
            <table border="0" class="car_tab" style="width:970px; margin-bottom:50px; margin-top: 4px"  cellspacing="0" cellpadding="0">
                <tr valign="top">
                    ...
                    <td class="car_th" width="200">数量</td>
                    <td class="car_th" width="100">单价</td>
                    <td class="car_th" width="100">小计</td>
                    <td class="car_th" width="170">操作</td>
                </tr>
                <?php if(is_array($buyCar)): $i = 0; $__LIST__ = $buyCar;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr align="center">
                        <td><?php echo ($v['goodsname']); ?></td>
                        <td>
                            <div class="c_s_img" style="margin-left: 50px"><img src="/Uploads/<?php echo ($v['pic']); ?>" /></div>
                        </td>
                        <td>
                            <div class="c_num">
                        ...
                        <td>
                            <a href="<?php echo U('Detail/detail1',array('id'=>$v['id']));?>">详情</a>&nbsp; &nbsp;
                            <a href="<?php echo U('BuyCar/buyCar_delete',array('id'=>$v['id']));?>">删除</a>&nbsp; &nbsp;
                        </td>
                ...
                <tr height="150" align="right">
                    <td colspan="8">
                        ...
                        <a href="<?php echo U('Home/Detail/orderDetail');?>">
