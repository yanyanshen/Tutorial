...
<div class="i_bg bg_color">
    ...
    <div class="left_m">
        ...
        <ul>
            <li><a href="<?php echo U('Home/Shop/shop_list');?>">购物车列表</a></li>
            <li><a href="<?php echo U('Home/Shop/shop_list');?>">购物车列表</a></li>
            <li><a href="<?php echo U('Home/Shop/shop_list');?>">购物车列表</a></li>
            <li><a href="<?php echo U('Home/Shop/shop_list');?>">购物车列表</a></li>
        </ul>
        ...
        <div class="m_right">
            <div class="m_des">
                <table border="0" style="width:870px; margin-bottom:50px;line-height:22px;" cellspacing="0" cellpadding="0">
                    <tr valign="top">
                        <td width="115">
                            <img src="/Uploads/<?php echo ($userPic); ?>"/>
                        </td>
                        <td>
                            <div class="m_user" style="font-size: 18px; font-weight: bold">尊贵的用户<a href="member_info.html" style="color: orangered"><?php echo ($nickname); ?></a>，您好！</div>
                            <p style="font-size: 14px">
                                今天是: <?=date("Y-m-d H:i:s")?><br />
                            </p>
                            <p style="font-size: 14px">
                                上次登录时间: <br />
                            </p>
            ...
            <div class="mem_t" style="font-size:18px;font-weight: bold">个人信息</div>
            <table border="0" class="mon_tab" style="width:870px; margin-bottom:20px;" cellspacing="0" cellpadding="0">
                <tr>
                    <td>
                        <div class="m_user">昵称：<?php echo ($nickname); ?></div><br/>
                        <div class="m_user">性别：<?php echo ($sex); ?></div><br/>
                        <div class="m_user">年龄：<?php echo ($age); ?></div><br/>
                        <div class="m_user">联系电话：<?php echo ($mobile); ?></div><br/>
                        <div class="m_user">联系邮箱：<?php echo ($email); ?></div><br/>
                        <div class="m_user">身份证号：<?php echo ($idNumber); ?></div><br/>
                        <div class="m_user">收货地址：<?php echo ($address); ?></div><br/>
                    </td>
                </tr>
            </table>
            <a href="<?php echo U('Member/member_editor');?>">
                <input type="button" value="修改资料" style="margin:25px 450px;font-size: 13px;" />
            </a>
        </div>
    </div>
</div>
