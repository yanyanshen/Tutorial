...
<div class="i_bg bg_color">
    ...
    <div class="left_m">
        ...
        <div class="m_right">
            <div class="m_des">
                <table border="0" style="width:870px; margin-bottom:50px;line-height:22px;" cellspacing="0" cellpadding="0">
                    <tr valign="top">
                        ...
                        <td>
                            <div class="m_user" style="font-size: 18px; font-weight: bold">尊贵的用户<a href="<?php echo U('MemberCenter/member_info');?>" style="color: orangered"><?php echo ($nickname); ?></a>，您好！</div>
            ...
            <a href="<?php echo U('MemberCenter/member_editor');?>">
