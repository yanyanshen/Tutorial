    ...
    <div class="left_m">
		...
		<div class="m_right">
            ...
            <form action="order_list">
                <table border="0" class="order_tab" style=" font-size:13px; width:930px; text-align:center; margin-bottom:30px;" cellspacing="0" cellpadding="0">
                    <tr>
                        <td width="20%">订单编号</td>
                        <td width="15%">下单用户</td>
                        <td width="10%">订单总额</td>
                    ...
                    <?php if(is_array($orderList)): $i = 0; $__LIST__ = $orderList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr>
                            <td style="color:#ff4e00;"><?php echo ($v['ordernumber']); ?></td>
                            <td><?php echo ($v['ordermember']); ?></td>
                            <td>￥<?php echo ($v['totalprice']); ?></td>
                            <td><?php echo ($v['createtime']); ?></td>
                            <td><?php echo ($v['orderstatus']); ?></td>
                            <td>
                                <a href="<?php echo U('MemberOrder/order_detail',array('id'=>$v['id']));?>" style="color:#ff4e00;">订单详情</a>&nbsp;&nbsp;&nbsp;&nbsp;
                                <a href="<?php echo U('MemberOrder/order_delete',array('id'=>$v['id']));?>" style="color:#ff4e00;">删除订单</a>
                            </td>
