 ...
 <div class="formbody">
    <div id="usual1" class="usual">
        <div id="tab1" class="tabson">
            <form action="<?php echo U('Admin/Goods/goodsadd');?>" method="post" enctype="multipart/form-data" onsubmit="return validate">
            <ul class="forminfo">
                <li><label>商品名称<b>*</b></label>
                    <input name="goodsname" type="text" class="dfinput" value=""  style="width:344px;"/>
                </li>
                ...
                <li><label>商品数量<b>*</b></label>
                    <input name="number" type="text" class="dfinput" value=""  style="width:167px;"/>
                </li>
