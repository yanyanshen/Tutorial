...
<style type="text/css">
    .Preferential_list .Complete .cx{ background:url(/Public/Home/images/cx.png) no-repeat; width:360px; height:338px; position:absolute; z-index:111; top:0px}
</style>
			...
			<div class="bd">
                <ul>
                    <?php if(is_array($adslist5)): $i = 0; $__LIST__ = $adslist5;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><li><a href="<?php echo U('Home/Ads/index');?>" target="_blank"><div style="background:url(/Public/Admin/Uploads/ads/<?php echo ($val["adlogo"]); ?>
                            ...
                            <li><a href="#" target="_blank"><div style="background:url(/Public/Home/images/AD/ad-9.jpg) no-repeat rgb(226, 155, 197); background-position:center; width:100%; height:350px;"></div></a></li>--><?php endforeach; endif; else: echo "" ;endif; ?>
                </ul>
			</div>
   ...
   <div class="pic_sort clearfix" id="Area">
       ...
       <?php if(is_array($salelist)): $k = 0; $__LIST__ = $salelist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($k % 2 );++$k; if($val["num"] == 0): ?><ul class="list Complete">
               ...
               <ul class="list">
                   ...
                   <li class="pic_img">
                       <a href="<?php echo U('Home/Sale/limitBuy',array('gid'=>$val['id']));?>"><img src="/Public/Admin/Uploads/goods/<?php echo ($val["pic"]); ?>" width="300px" height="200px"></a>
                   </li>
                   <li class="pic_inner">
                       <div class="btn"><a href="<?php echo U('Home/Sale/limitBuy',array('gid'=>$val['id']));?>" class="btn_gm"></a></div>
                       <div class="pic_Price left"><b>￥<?php echo ($val["price"]); ?></b></div>
                       <div class="Number right">
                           <p class="Number_Price">￥<?php echo ($val["marketprice"]); ?></p>
                           <p class="pic_Number"><?php echo ($val["num"]); ?>件</p>
