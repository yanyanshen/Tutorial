        ...
        <div class="right_style" style="margin-top:10px;margin-left: 100px;width: 860px;">
            <div class="info_content">
                ...
                <div class="Personal_info" id="Personal">
                    ...
                    <form id="formInfo" action="<?php echo U('Personal/memberInfo');?>" method="post" enctype="multipart/form-data">
                        <ul class="xinxi">
                            <li class="User_avatar" style="width: 110px;height: 110px;border: 0"><label>当前头像：</label>
                                <?php if($memberlist['pic'] == 0): ?><img id="img0" src="/Public/Home/images/people.png" style="width: 100px;height: 100px;float: left;position: absolute;left: 700px;"/>
                                <?php else: ?>
                                    <img id="img0" src="/Public/Admin/Uploads/member/<?php echo ($memberlist['pic']); ?>" style="width: 100px;height: 100px;float: left;position: absolute;left: 700px;" /><?php endif; ?>
                            </li>
                            <li><input name="pic" type="file" id="file0" style="width: 75px;height: 25px;margin-left: 110px;" value="上传头像"  class="submit" /></li>
                        <li><label>用户姓名：</label>  <span><input name="username" type="text" value="<?php echo ($memberlist["username"]); ?>"  class="text"  disabled="disabled"/></span></li>
                        </li>
                        <li><label>用户性别：</label> <span class="sex">
                            <?php if($memberlist['gender'] == 0): ?>男
                                <?php elseif($memberlist['gender'] == 1): ?>女
                            ...
                            <div class="add_sex">
                                ...
                                女&nbsp;&nbsp;</div></li>
                        <li><label>电子邮箱：</label>  <span><input name="email" type="text" value="<?php echo ($memberlist['email']); ?>"  class="text"  disabled="disabled"/></span></li>
                        <li><label>用户QQ：</label>  <span><input name="qq" type="text" value="<?php echo ($memberlist['qq']); ?>"  class="text"  disabled="disabled"/></span></li>
                        <li><label>移动电话：</label>  <span><input name="mobile" type="text" value="<?php echo ($memberlist['mobile']); ?>"  class="text"  disabled="disabled"/></span></li>
                        <div class="bottom">
        ...
        $('#formInfo').ajaxSubmit(function(res){
            if(res.status=="ok"){
                layer.msg(res.msg,{icon:1,time:500},function(){
                    window.location.href="<?php echo U('Personal/memberInfo');?>";
                })
            }else{
                layer.alert(res.msg);
            }
