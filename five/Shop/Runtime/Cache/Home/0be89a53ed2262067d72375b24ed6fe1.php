    ...
    <div id="Filter_style">
        ...
        <div class="Filter">
            <div class="Filter_list clearfix" id="brandstyle">
                ...
                <div class="Filter_Entire"><a id="0" href="<?php echo U('Home/ProductList/showlist',array('bid'=>0,'maxprice'=>0,'minprice'=>0));?>" class="Complete">全部</a></div>
                <div class="p_f_name infonav_hidden" style="height: 85px;">
                        ...
                        <p>
                            <?php if(is_array($brandlist)): $key = 0; $__LIST__ = $brandlist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($key % 8 );++$key;?><a id="<?php echo ($val["id"]); ?>"  href="<?php echo U('Home/ProductList/showlist',array('bid'=>$val['id'],'maxprice'=>0,'minprice'=>0));?>" ><?php echo ($val["bname"]); ?></a>
                                <?php if(($mod) == "7"): ?><p/><p><?php endif; endforeach; endif; else: echo "" ;endif; ?>
                </div>
            ...
            <div class="Filter_list clearfix">
                ...
                <div class="<?php echo ($min==0?'bs':'hy'); ?>"><a  href="<?php echo U('Home/ProductList/showlist',array('minprice'=>0,'maxprice'=>0));?>">全部</a></div>
                <div class="<?php echo ($min==1?'bs':'hy'); ?>"><a   href="<?php echo U('Home/ProductList/showlist',array('minprice'=>1,'maxprice'=>50));?>">1-50</a></div>
                <div class="<?php echo ($min==50?'bs':'hy'); ?>"><a   href="<?php echo U('Home/ProductList/showlist',array('minprice'=>50,'maxprice'=>150));?>">50-150</a></div>
                <div class="<?php echo ($min==150?'bs':'hy'); ?>"> <a  href="<?php echo U('Home/ProductList/showlist',array('minprice'=>150,'maxprice'=>500));?>">150-500</a></div>
                <div class="<?php echo ($min==500?'bs':'hy'); ?>"><a  href="<?php echo U('Home/ProductList/showlist',array('minprice'=>500,'maxprice'=>1000));?>">500-1000</a></div>
                <div class="<?php echo ($min==1000?'bs':'hy'); ?>"><a  href="<?php echo U('Home/ProductList/showlist',array('minprice'=>1000,'maxprice'=>10000000));?>">1000以上</a></div>
            </div>
            ...
            <div class=" side_list">
                ...
                <div class="pro_ranking">
                    ...
                    <div class="ranking_list">
                        <ul id="tabRank">
                          <?php if(is_array($rank)): $k = 0; $__LIST__ = $rank;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($k % 2 );++$k;?><li class="t_p on">
                                <em class="icon_ranking"><?php echo ($k); ?></em>
                                <dt><h3><a href="<?php echo U('Detail/detail',array('gid'=>$v['id']));?>"><?php echo ($v['goodsname']); ?></a></h3></dt>
                                <dd class="clearfix">
                                    <a href="<?php echo U('Detail/detail',array('gid'=>$v['id']));?>"><img src="/Public/Admin/Uploads/goods/thumb100/100_<?php echo ($v['pic']); ?>" width="90" height="90" /></a>
                                    <span class="Price">￥<?php echo ($v["price"]); ?></span>
                                    <span class="Price" style="font-size: 12px;margin: 10px"> 销量:<?php echo ($v["salenum"]); ?></span>
                                </dd>
            ...
            <div id="Sorted" >
                <div class="Sorted">
                    <div class="Sorted_style">
                        <a id="a0" class="<?php echo ($orderIT==0?'on':''); ?>" href="<?php echo U('Home/ProductList/showlist',array('order'=>0));?>" class="on">综合<i class="iconfont icon-fold"></i></a>
                        <a id="a1" class="<?php echo ($orderIT==1?'on':''); ?>"  href="<?php echo U('Home/ProductList/showlist',array('order'=>1));?>">销量<i class="iconfont icon-fold"></i></a>
                        <a id="a2" class="<?php echo ($orderIT==2?'on':''); ?>" href="<?php echo U('Home/ProductList/showlist',array('order'=>2));?>">价格<i class="iconfont icon-fold"></i></a>
                        <a id="a3" class="<?php echo ($orderIT==3?'on':''); ?>" href="<?php echo U('Home/ProductList/showlist',array('order'=>3));?>">新品<i class="iconfont icon-fold"></i></a>
                    </div>
                    <!--产品搜索-->
