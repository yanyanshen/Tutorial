...
<div style="margin-bottom:20px;padding:45px;height: 300px">
    <div class="box">
        <h1 style="color:#71B247;height:150px;line-height:150px;padding-left:100px;margin:10px 0;background:url('/Public/Home/images//ok.jpg') no-repeat left 30px;">
            订单<?php echo ($orderSyn); ?>支付成功！<a href="<?php echo U('Home/Index/index');?>" style="margin:0px 10px;" target="_self">返回首页继续购物</a>
        </h1>
    ...
    <div class="pxlistcon box">
         <div class="pxlist" >
            <h3>购买该商品的用户还购买了</h3>
            <ul>
                <?php if(is_array($goodsInfo)): $i = 0; $__LIST__ = $goodsInfo;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><li>
                   <a href="<?php echo U('Detail/detail',array('gid'=>$val['id']));?>" title="">
                        <img src="/Public/Admin/Uploads/goods/<?php echo ($val['pic']); ?>" alt="" />
                ...
                <!--<li>
                   <a href="#" title="">
                        <img src="/Public/Home/images//iphone.jpg" alt="" />
