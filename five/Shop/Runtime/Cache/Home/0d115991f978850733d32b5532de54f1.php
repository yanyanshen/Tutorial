                ...
                <div id="tabbox">
                    ...
                    <ul class="tab_conbox">
                        <li id="tab1" class="tab_con">
                            <table class="tablelist">
                                ...
                                <?php if(is_array($list)): $k = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "$empty" ;else: foreach($__LIST__ as $key=>$val): $mod = ($k % 2 );++$k;?><tr>
                                        <td><?php echo ($k); ?></td>
                                        <td><img src="/Public/Admin/Uploads/goods/thumb100/100_<?php echo ($val['pic']); ?>" style="width: 50px;height: 50px;"></td>
                                        <td><?php echo (mb_substr($val["goodsname"],0,20,'utf-8')); ?></td>
                                        <td><?php echo ($val["price"]); ?></td>
                                        <td><?php echo ($val["buynum"]); ?></td>
                                        <td><?php echo ($val['price']*$val['buynum']); ?></td>
                                        <td><a href="javascript:comment(<?php echo ($val['id']); ?>,<?php echo ($val['oid']); ?>)" class="tablelink">我要评价</a></td>
                        ...
                        <li id="tab2" class="tab_con">
                            ...
                            <tbody>
                                <?php if(is_array($aready)): $k = 0; $__LIST__ = $aready;if( count($__LIST__)==0 ) : echo "$empty" ;else: foreach($__LIST__ as $key=>$val): $mod = ($k % 2 );++$k;?><tr>
                                        <td><?php echo ($k); ?></td>
                                        <td><img src="/Public/Admin/Uploads/goods/thumb100/100_<?php echo ($val['pic']); ?>" style="width: 50px;height: 50px;"></td>
                                        <td><?php echo (mb_substr($val["goodsname"],0,20,'utf-8')); ?></td>
                                        <td><?php echo ($val["price"]); ?></td>
                                        <td><?php echo ($val["buynum"]); ?></td>
                                        <td><?php echo ($val['price']*$val['buynum']); ?></td>
                                        <td><?php echo (mb_substr($val["commentcontent"], 0,10,'utf-8')); ?></td>
                                        <td><a href="javascript:del(<?php echo ($val['id']); ?>)">删除</a>
                                            <a href="<?php echo U('Detail/detail',array('gid'=>$val['gid']));?>">查看详情</a></td>
                                    </tr><?php endforeach; endif; else: echo "$empty" ;endif; ?>
                           </tbody>
                            </table>
                        </li>
