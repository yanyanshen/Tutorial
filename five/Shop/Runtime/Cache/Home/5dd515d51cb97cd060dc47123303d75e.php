        ...
        <div id="box">
            <div class="content" style="display:block;width:900px;height:500px;border:1px solid gray;padding-top:20px;">
                ...
                <div style="height:400px;margin-left:30px;margin-top:20px;">
                    <form action="<?php echo U('Personal/editLoginPwd');?>" method="post" id="accountForm1">
            ...
            <div class="content" style="display:none;width:900px;height:500px;border:1px solid gray;padding-top:20px;">
                ...
                <div style="height:400px;margin-left:30px;margin-top:20px;">
                    <form action="<?php echo U('Personal/accountAdd');?>" method="post" id="accountForm3">
                        <div style="height:40px;margin-top:30px;">
            ...
            <div class="content" style="display:none;width:900px;height:500px;border:1px solid gray;padding-top:20px;">
                ...
                <div style="height:400px;margin-left:30px;margin-top:20px;">
                    <form action="<?php echo U('Personal/editPayPwd');?>" method="post" id="accountForm2">
                    <div style="height:40px;margin-top:30px;">
                        <span style="margin-left:150px;padding-left:30px;line-height:40px;font-size:20px;">用户名:</span>
...
<script>
    $(function(){
        ...
        $("#editlogin").click(function(){
            if(Obj.form()){
                $.post("<?php echo U('Personal/editLoginPwd');?>",$("#accountForm1").serialize(),function(res){
                    if(res.status=="ok"){
                        layer.msg(res.msg,{icon:1,time:2000},function(){
                            window.location.href="<?php echo U('Personal/safety');?>";
                        })
                    }else{
    ...
    $(function(){
        ...
        $("#editpay").click(function(){
            if(Obj.form()){
                $.post("<?php echo U('Personal/editPayPwd');?>",$("#accountForm2").serialize(),function(res){
                    if(res.status=="ok"){
                        layer.msg(res.msg,{icon:1,time:2000},function(){
                            window.location.href="<?php echo U('Personal/safety');?>";
                        })
        ...
        $("#accountAdd").click(function(){
                $.post("<?php echo U('Personal/accountAdd');?>",$("#accountForm3").serialize(),function(res){
                    if(res.status=="ok"){
                        layer.msg(res.msg,{icon:1,time:2000},function(){
                            window.location.href="<?php echo U('Personal/safety');?>";
                        })
