...
<div class="shoppingMain">
    ...
    <div class="border">
        <div class="myCar">
            <div class="success">
                <h3>订单已提交成功，请尽快付款！</h3>
                <p class="p1">您的订单号：<span><?php echo ($orderInfo["order_syn"]); ?></span>
                <p class="p2">订单金额：<span><?php echo (floor($orderInfo["order_price"]*10)); ?></span>积分</p>
            </div>
            <div class="pay1">
                <div class="chir_pay">
                ...
                <form action="<?php echo U('Home/Pay/topay');?>" method="post" id="myform2">
                ...
                <div id="div2" style="display: none">
                    ...
                    <div class="pay3">
                        <ul class="clearfixs">
                            <li><input type="radio"name="radio"value="3"> <img src="/Public/Home/images/logo_alipay.gif" alt="" /></li>
                            <li><input type="radio" name="radio"value="4"> <img src="/Public/Home/images/logo_yeepay.gif" alt="" /></li>
                            <li><input type="radio" name="radio"value="5"> <img src="/Public/Home/images/logo_weixin.gif" alt="" /></li>
                        </ul>
                    </div>
                </div>
...
<script>
    ...
    $(function(){
        $("#subBtn").click(function(){
            $.post("<?php echo U('Home/Pay/topay');?>",$("#myform2").serialize(),function(res){
                if(res.status=="ok"){
                    layer.msg(res.msg,{icon:1,time:1000},function(){
                        window.location.href="<?php echo U('Home/Order/submitOrderSuccess');?>?oid="+res.oid+"&orderSyn="+res.orderSyn;
                    })
                }else{
