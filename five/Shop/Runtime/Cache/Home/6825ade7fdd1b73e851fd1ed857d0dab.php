    ...
    <div class="m_content">
        <div class="m_left">
            ...
            <div class="left_m">
                ...
                <ul>
                    <li><a href="<?php echo U('Personal/order');?>">我的订单</a></li>
            ...
            <div class="left_m">
                ...
                <ul>
                    ...
                    <li><a href="<?php echo U('Personal/feedback');?>">用户反馈</a></li>
                </ul>
            </div>
        </div>
        <div class="m_right">
            ...
            <div class="right_style">
                <div class="info_content">
                    ...
                    <div class="user_info">
                        <ul class="">
                            <li class="Balance" style="width: 170px;"><a href="<?php echo U('Personal/safety');?>"><img src="/Public/Home/images/user_img_05.png" /><h4>余额：￥<?php echo ($level["money"]); ?></h4></a></li>
                            <li class="Order_form" style="width: 170px;"><a href="<?php echo U('Personal/order');?>"><img src="/Public/Home/images/user_img_04.png" /><h4>订单：(<?php echo ($sum["count"]); ?>)</h4></a></li>
                            <li class="grade" style="width: 170px;"><a href="<?php echo U('Personal/myCart');?>"><img src="/Public/Home/images/user_img_09.png" />
                                <?php if($cart != null): ?><h4>购物车数量 : <?php echo ($cart["count"]); ?></h4><?php else: ?><h4>购物车数量 : 0</h4><?php endif; ?>
                            </a></li>
                            <li class="Favorable" style="width: 170px;"><a href="<?php echo U('Personal/memberLevel');?>"><img src="/Public/Home/images/user_img_07.png" /><h4><?php echo ($level["level_name"]); ?></h4></a></li>
                            <li class="integral" style="width: 170px;"><a href="<?php echo U('Personal/point');?>"><img src="/Public/Home/images/user_img_06.png" /><h4><?php echo ($level["credit"]); ?>分</h4></a></li>
                        </ul>
                    </div>
                    <!--样式-->
                    <div class="user_info_p_s  clearfix">
                            ...
                            <div class="us_Orders left clearfix" style="width:600px;float: left;left: 0">
                                ...
                                <table style="width:600px;float: left;left: 0">
                                    ...
                                    <?php if(is_array($list)): $k = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($k % 2 );++$k;?><tr>
                                            <td >
                                                <a href="#" class="img"><img src="/Public/Admin/Uploads/goods/thumb100/100_<?php echo ($val['pic']); ?>" width="80" height="80"></a>
                                                <a href="#" class="title" style="line-height: 60px;"><?php echo (mb_substr($val["goodsname"],0,15,'utf-8')); ?></a>
                                            </td>
                                            <td><?php echo ($val["status_name"]); ?></td>
                                            <td><a href="<?php echo U('Detail/detail',array('gid'=>$val['id']));?>" class="View">查看</a></td>
                                        </tr><?php endforeach; endif; else: echo "" ;endif; ?>
                                    </tbody>
                                </table>
                                <div class="us_jls"><a href="<?php echo U('Personal/order');?>" style="margin-top: 10px;font-size: 20px;">查看更多</a></div>
                            </div>
                        </div>
                        <!--右侧记录样式--><!--这放一个日历插件-->
                        <!--右侧记录样式-->
                        <div class="right_user_recording" style="width: 350px;">
                            <div class="us_Record" style="width: 350px;">
                                ...
                                <div class="y" style="width:230px;float: left;left:0;">
...
<head>
    ...
    <!--
     ...
     -->
    <!--<link rel="stylesheet" href=/Public/Home/css/calendar.css" media="screen">-->
    <style type="text/css">
...
<script src="/Public/Home/js/jquery-ui-datepicker.min.js"></script>
<script>
    $('#calendar').datepicker({
        inline: true,
        firstDay: 1,
