...
<div class="Inside_pages clearfix">
    ...
    <div class="limit_style Preferential_list">
        <div class="pic_sort clearfix" id="Area">
            <?php if(is_array($decade)): $k = 0; $__LIST__ = $decade;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($k % 2 );++$k;?><ul class="list">
                        <li class="pic_img">
                            <a href="<?php echo U('Detail/detail',array('gid'=>$val['id']));?>"><img src="/Public/Admin/Uploads/goods/<?php echo ($val["pic"]); ?>" width="300px" height="200px"></a>
                        </li>
                        <li class="pic_inner">
                            <div class="btn"><a href="<?php echo U('Detail/detail',array('gid'=>$val['id']));?>" class="btn_gm"></a></div>
