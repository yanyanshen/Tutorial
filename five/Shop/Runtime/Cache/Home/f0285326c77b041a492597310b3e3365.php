            ...
            <div class="info_content">
                ...
                <div class="integral">
                    ...
                    <div class="user_integral_style slideTxtBox">
                        ...
                        <div class="bd">
                            <ul>
                                <div class="Integral_Number"><em></em>你当前的积分：<b><?php echo ($sum['credit']); ?></b></div>
                                <table>
                                    <thead>
                                    ...
                                    <tbody>
                                    <?php if(is_array($point)): $k = 0; $__LIST__ = $point;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($k % 2 );++$k;?><tr>
                                            <td><?php echo ($val["order_syn"]); ?></td>
                                            <td>￥<?php echo ($val["order_price"]); ?></td>
                                            <td><?php echo floor($val['order_price']/10);?></td>
                            ...
                            <ul>
                                <div class="Integral_Number"><em></em>你兑换的积分：<b><?php echo ($usesum); ?></b></div>
                                <table>
                                    <thead>
                                    <tr class="thead_title">
                                        <td>编号</td>
                                    ...
                                    <tbody>
                                    <?php if(is_array($usepoint)): $k = 0; $__LIST__ = $usepoint;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($k % 2 );++$k;?><tr>
                                            <td><?php echo ($k); ?></td>
                                            <td><?php echo (mb_substr($val["goodsname"],0,20,'utf-8')); ?></td>
                                            <td><img src="/Public/Admin/Uploads/goods/thumb100/100_<?php echo ($val['pic']); ?>"></td>
                                            <td><?php echo date('Y-m-d H:i:s',$val['addtime']);?></td>
                                        </tr><?php endforeach; endif; else: echo "" ;endif; ?>
                                    </tbody>
                                </table>
