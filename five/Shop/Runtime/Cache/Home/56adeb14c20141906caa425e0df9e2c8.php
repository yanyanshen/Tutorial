...
<div id="header_top">
    ...
    <link href="/Public/Home/css/ad.css" rel="stylesheet" type="text/css" />
    <script src="/Public/Home/js/jquery.min.1.8.2.js" type="text/javascript"></script>
    <script src="/Public/Home/js/jquery.SuperSlide.2.1.1.js" type="text/javascript"></script>
    <title>易田商城首页</title>
...
<div class="AD_bg_img">
    ...
    <div class="slider">
        <div id="slideBox" class="slideBox">
            ...
            <div class="bd">
                <ul>
                    <li><a href="#" target="_blank"><img src="/Public/Home/images/ads/AD_img.png" /></a></li>
                </ul>
            </div>
...
<div class="recommend_style ">
    ...
    <div class="mian">
        ...
        <div class="carouFredSel">
            ...
            <div id="center">
                <div id="slider">
                    <?php if(is_array($list2)): $i = 0; $__LIST__ = $list2;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><div class="slide">
                        <a href="<?php echo U('Detail/detail',array('gid'=>$val['id']));?>" title="水果" target="_blank">
                            <img class="diapo" border="0" src="/Public/Admin/Uploads/goods/thumb800/800_<?php echo ($val['pic']); ?>" style=" width:605px;opacity: 1; visibility: visible;"></a>
                        <div class="backgroundText_name" >
                            <div class="product_info">
                                <h2><?php echo ($val["goodsname"]); ?></h2>
                                <h5>原产地：云和商城</h5>
                                <p>原价：<b>￥<?php echo ($val["marketprice"]); ?></b></p>
                            </div>
                            <div class="product_price">
                                <a href="#" class="price_btn">
                                    <p class="left_title_p"></p>
                                    <p class="zj_bf"><em>￥</em><?php echo ($val["price"]); ?></p>
                                    <p class="right_buf"></p>
                                </a>
                            </div>
                        </div>
            ...
            <div class="bd">
                ...
                <ul class="">
                    <li class="advertising">
                        <div class="AD1"><a href="<?php echo U('Detail/detail',array('gid'=>$list2[2]['id']));?>"><img style="width: 560px;height: 255px" src="/Public/Admin/Uploads/goods/thumb800/800_<?php echo ($list2[2]['pic']); ?>" /></a></div>
                        <div class="AD2">
                            <a href="<?php echo U('Detail/detail',array('gid'=>$list2[1]['id']));?>"><img style="width: 450px;height: 254px"  src="/Public/Admin/Uploads/goods/thumb800/800_<?php echo ($list2[1]['pic']); ?>" /></a>
                            <a href="<?php echo U('Detail/detail',array('gid'=>$list2[0]['id']));?>"><img style="width: 450px;height: 254px" src="/Public/Admin/Uploads/goods/thumb800/800_<?php echo ($list2[0]['pic']); ?>" /></a>
                        </div>
                        <div class="AD3"><a href="<?php echo U('Detail/detail',array('gid'=>$list2[3]['id']));?>"><img  style="width: 265px;height: 510px;" src="/Public/Admin/Uploads/goods/thumb800/800_<?php echo ($list2[3]['pic']); ?>" /></a></div>
                    </li>

                    <li class="advertising">
                        <div class="AD1"><a href="<?php echo U('Detail/detail',array('gid'=>$list1[2]['id']));?>"><img style="width: 560px;height: 255px" src="/Public/Admin/Uploads/goods/thumb800/800_<?php echo ($list1[2]['pic']); ?>" /></a></div>
                        <div class="AD2">
                            <a href="<?php echo U('Detail/detail',array('gid'=>$list1[1]['id']));?>"><img style="width: 450px;height: 254px"  src="/Public/Admin/Uploads/goods/thumb800/800_<?php echo ($list1[1]['pic']); ?>" /></a>
                            <a href="<?php echo U('Detail/detail',array('gid'=>$list1[0]['id']));?>"><img style="width: 450px;height: 254px" src="/Public/Admin/Uploads/goods/thumb800/800_<?php echo ($list1[0]['pic']); ?>" /></a>
                        </div>
                        <div class="AD3"><a href="<?php echo U('Detail/detail',array('gid'=>$list1[3]['id']));?>"><img  style="width: 265px;height: 510px;" src="/Public/Admin/Uploads/goods/thumb800/800_<?php echo ($list1[3]['pic']); ?>" /></a></div>
                    </li>
                    <li class="advertising">
                        <div class="AD1"><a href="<?php echo U('Detail/detail',array('gid'=>$list3[2]['id']));?>"><img style="width: 560px;height: 255px" src="/Public/Admin/Uploads/goods/thumb800/800_<?php echo ($list3[2]['pic']); ?>" /></a></div>
                        <div class="AD2">
                            <a href="<?php echo U('Detail/detail',array('gid'=>$list3[1]['id']));?>"><img style="width: 450px;height: 254px"  src="/Public/Admin/Uploads/goods/thumb800/800_<?php echo ($list3[1]['pic']); ?>" /></a>
                            <a href="<?php echo U('Detail/detail',array('gid'=>$list3[0]['id']));?>"><img style="width: 450px;height: 254px" src="/Public/Admin/Uploads/goods/thumb800/800_<?php echo ($list3[0]['pic']); ?>" /></a>
                        </div>
                        <div class="AD3"><a href="<?php echo U('Detail/detail',array('gid'=>$list3[3]['id']));?>"><img  style="width: 265px;height: 510px;" src="/Public/Admin/Uploads/goods/thumb800/800_<?php echo ($list3[3]['pic']); ?>" /></a></div>
                    </li>
                    <li class="advertising">
                        <div class="AD1"><a href="<?php echo U('Detail/detail',array('gid'=>$list4[2]['id']));?>"><img style="width: 560px;height: 255px" src="/Public/Admin/Uploads/goods/thumb800/800_<?php echo ($list4[2]['pic']); ?>" /></a></div>
                        <div class="AD2">
                            <a href="<?php echo U('Detail/detail',array('gid'=>$list4[5]['id']));?>"><img style="width: 450px;height: 254px"  src="/Public/Admin/Uploads/goods/thumb800/800_<?php echo ($list4[5]['pic']); ?>" /></a>
                            <a href="<?php echo U('Detail/detail',array('gid'=>$list4[4]['id']));?>"><img style="width: 450px;height: 254px" src="/Public/Admin/Uploads/goods/thumb800/800_<?php echo ($list4[4]['pic']); ?>" /></a>
                        </div>
                        <div class=""><a href="<?php echo U('Detail/detail',array('gid'=>$list4[3]['id']));?>"><img  style="width: 265px;height: 510px;" src="/Public/Admin/Uploads/goods/thumb800/800_<?php echo ($list4[3]['pic']); ?>" /></a></div>
                    </li>
                </ul>
            </div>
        </div>
