    ...
    <div id="Filter_style">
        ...
        <div class="Filter">
            <div class="Filter_list clearfix" id="brandstyle">
                ...
                <div class="Filter_Entire"><a id="0" href="<?php echo U('Home/ProductList/showlist',array('bid'=>0,'maxprice'=>0,'minprice'=>0,'words'=>'0'));?>">全部</a></div>
            ...
            <div class="Filter_list clearfix">
                ...
                <div class="<?php echo ($min==0?'bs':'hy'); ?>"><a  href="<?php echo U('Home/ProductList/searchlist',array('minprice'=>0,'maxprice'=>0));?>">全部</a></div>
                <div class="<?php echo ($min==1?'bs':'hy'); ?>"><a   href="<?php echo U('Home/ProductList/searchlist',array('minprice'=>1,'maxprice'=>50));?>">1-50</a></div>
                <div class="<?php echo ($min==50?'bs':'hy'); ?>"><a   href="<?php echo U('Home/ProductList/searchlist',array('minprice'=>50,'maxprice'=>150));?>">50-150</a></div>
                <div class="<?php echo ($min==150?'bs':'hy'); ?>"> <a  href="<?php echo U('Home/ProductList/searchlist',array('minprice'=>150,'maxprice'=>500));?>">150-500</a></div>
                <div class="<?php echo ($min==500?'bs':'hy'); ?>"><a  href="<?php echo U('Home/ProductList/searchlist',array('minprice'=>500,'maxprice'=>1000));?>">500-1000</a></div>
                <div class="<?php echo ($min==1000?'bs':'hy'); ?>"><a  href="<?php echo U('Home/ProductList/searchlist',array('minprice'=>1000,'maxprice'=>10000000));?>">1000以上</a></div>
            </div>
        </div>
    </div>
            ...
            <div id="Sorted" >
                <div class="Sorted">
                    <div class="Sorted_style">
                        ...
                        <a id="a0" class="<?php echo ($orderIT==0?'on':''); ?>" href="<?php echo U('Home/ProductList/searchlist',array('order'=>0));?>" class="on">综合<i class="iconfont icon-fold"></i></a>
                        <a id="a1" class="<?php echo ($orderIT==1?'on':''); ?>"  href="<?php echo U('Home/ProductList/searchlist',array('order'=>1));?>">销量<i class="iconfont icon-fold"></i></a>
                        <a id="a2" class="<?php echo ($orderIT==2?'on':''); ?>" href="<?php echo U('Home/ProductList/searchlist',array('order'=>2));?>">价格<i class="iconfont icon-fold"></i></a>
                        <a id="a3" class="<?php echo ($orderIT==3?'on':''); ?>" href="<?php echo U('Home/ProductList/searchlist',array('order'=>3));?>">新品<i class="iconfont icon-fold"></i></a>
                    </div>
