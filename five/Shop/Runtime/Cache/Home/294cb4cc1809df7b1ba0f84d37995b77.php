        ...
        <div style="width:900px;height:500px;border:1px solid gray;">
            <div style="float: left;width:40%;height:480px;">
                <div style="height:40px;margin-top:30px;">
                    ...
                    <span style="padding-left:30px;font-size:20px;"><?php echo ($memberLevel['username']); ?></span>
                </div>
                <div style="height:40px;margin-top:30px;">
                    <span style="padding-left:30px;line-height:40px;font-size:24px;">性别:</span>
                    <?php if($memberLevel['gender'] == 0): ?><span style="padding-left:30px;font-size:20px;">女</span>
                        <?php elseif($memberLevel['gender'] == 1): ?>
                        <span style="padding-left:30px;font-size:20px;">男</span>
                        <?php else: ?>
                        <span style="padding-left:30px;font-size:20px;">保密</span><?php endif; ?>
                </div>
                <div style="height:40px;margin-top:30px;">
                    <span style="padding-left:30px;line-height:40px;font-size:24px;">会员等级:</span>
                    <span style="padding-left:30px;font-size:20px;font-weight:bolder;color:red;"><?php echo ($memberLevel['level_name']); ?></span>
                </div>
                <div style="height:40px;margin-top:30px;">
                    <span style="padding-left:30px;line-height:40px;font-size:24px;">当前消费额度:</span>
                    <span style="padding-left:30px;font-size:24px;color:#FF7200"><?php echo ($memberLevel['costs']); ?></span>
                </div>
            </div>
