...
<div class="zong">
    <div class="neirong">
        <form action="" method="post" id="myform1">
            <div class="logo" ><img src="/Public/Home/images/tu.gif" style="height: 90px;margin-top: 20px"></div>
            <h3>用户登陆</h3>
...
<script type="text/javascript">
    $(function(){
        $(".submit").click(function(){
            $.post("<?php echo U('Member/login');?>",$("#myform1").serialize(),function(res){
                if(res.status==1){
                    layer.msg(res.info,{icon:1,time:1000},function(){
//                        parent.layer.closeAll();
                        parent.location.reload();
                       // parent.location.href="<?php echo U('Detail/detail');?>";
                    })
                }else{
