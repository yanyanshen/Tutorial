            ...
            <div class="product_List">
                ...
                <table>
                    ...
                    <?php if(is_array($goodsInfo)): $i = 0; $__LIST__ = $goodsInfo;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val3): $mod = ($i % 2 );++$i;?><tr>
                            ...
                            <td style="color:red;"><?php echo (floor($val3["price"]*10)); ?> <i>积分</i></td>
                            <td><?php echo ($val3["buynum"]); ?></td>
                            <td class="Moneys"><?php echo (floor($val3["price"]*$val3["buynum"]*10)); ?> <i style="color:red;">积分</i></td>
                ...
                <div class="price_style">
                    <div class="right_direction">
                        <ul>
                            <li><label>商品总价</label><span><?php echo (floor($val3["order_price"]*10)); ?> 积分</span></li>
                        </ul>
                        <div class="btn">
...
<script type="text/javascript">
    ...
    $(function(){
        $("#submit_btn").click(function(){
            $.post("<?php echo U('Pay/integralpaylist');?>",$("#myform").serialize(),function(res){
                if(res.status=="ok"){
                    layer.msg(res.msg,{icon:1,time:2000},function(){
                        window.location.href="<?php echo U('Pay/integralpaylist');?>?order_syn="+res.order_syn+"&order_price="+res.order_price+"&oid="+res.oid;
                    })
                }else{
