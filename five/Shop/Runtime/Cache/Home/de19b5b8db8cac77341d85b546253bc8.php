...
<div class="limit_style" id="">
    <div id="slideBox" class="slideBox">
        ...
        <div class="bd">
            <ul>
                <?php if(is_array($ads)): $i = 0; $__LIST__ = $ads;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><li><a href="<?php echo U('Integral/ads');?>" target="_blank">
                    <div style="background:url(/Public/Admin/Uploads/ads/<?php echo ($val['adlogo']); ?>) no-repeat rgb(255, 227, 130); background-position:center; width:100%; height:400px;">
...
<div class="Inside_pages clearfix">
    ...
    <div class="limit_style Preferential_list">
        <div class="pic_sort clearfix" id="Area">
            ...
            <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><ul class="list">
                <li class="pic_time">积分兑换</li>
                <li class="pic_img">
                    <a href="<?php echo U('Integral/detail',array('gid'=>$val['id']));?>"><img src="/Public/Admin/Uploads/goods/thumb350/350_<?php echo ($val['pic']); ?>" style="width: 250px;height:200px;"></a>
                </li>
                <li class="pic_inner">
                    <!--<div class="btn"><a href="#" class="btn_gm"></a></div>-->
                    <div class="btn"><a href="<?php echo U('Integral/detail',array('gid'=>$val['id']));?>"><img src="/Public/Home/images/jf.png"></a></div>
                    <div class="pic_Price left"><b style="font-size: 20px;">&nbsp;&nbsp;<?php echo (floor($val["price"])); ?>积分 <img src="/Public/Home/images/moneychange.png" style="margin: 7px 0 0 10px;"></b></div>
