...
//        document.getElementById("ECS_FORMBUY").submit();
        var mid=$('#mid').val();
        if( mid){
            $.post("<?php echo U('Order/integral');?>",$("#ECS_FORMBUY").serialize(),function(res){
                if(res.status=="ok"){
                    layer.msg(res.msg,{icon:6,time:2000},function(){
                        window.location.href="<?php echo U('Order/integralOrder');?>?oid="+res.oid;
                    })
                }else{
            ...
            layer.alert("登陆成功后才能进行积分兑换",{icon:4},function(){
                layer.open({
                    ...
                    shadeClose: true,
                    shade: 0.8,
                    content:"<?php echo U('Integral/tologin');?>"
                })
            })
        }
    }
...
<div class="clearfix Inside_pages">
    ...
    <div class="clearfix" id="goodsInfo">
            ...
            <div class="clearfix" id="detail_main_img">
                <div class="layout_wrap preview">
                    <div id="vertical" class="bigImg">
                        <img src="/Public/Admin/Uploads/goods/thumb800/800_<?php echo ($list['pic']); ?>" width="" height="" alt="" id="midimg" />
                    ...
                    <div class="smallImg">
                        ...
                        <div id="imageMenu">
                            <ul>
                                <?php if(is_array($listpic)): $i = 0; $__LIST__ = $listpic;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><li><img src="/Public/Admin/Uploads/goods/thumb350/350_<?php echo ($val['picname']); ?>" width="68" height="68" alt=""/></li><?php endforeach; endif; else: echo "" ;endif; ?>
                            </ul>
                        </div>
        ...
        <!--产品信息-->
        <div class="property">
            <form action="<?php echo U('Order/integral');?>" method="post" name="ECS_FORMBUY" id="ECS_FORMBUY">
                <input type="hidden" name="gid" value="<?php echo ($list['id']); ?>">
                <input type="hidden" name="price" value="<?php echo (floor($list['price'])); ?>">
                <h2><?php echo ($list["goodsname"]); ?></h2>
                <div class="goods_info"><?php echo ($list["introduction"]); ?></div>
                <div class="ProductD clearfix">
                    <div class="productDL">
                        <dl><dt>兑换价格：</dt><dd><span><i></i><?php echo (floor($list["price"])); ?> 积分</span></dd></dl>
                        <!--<dl><dt>商品价格：</dt><dd><?php echo ($list['price']); ?></dd></dl>-->
                    </div>
                </div>
                <div class="buyinfo" id="detail_buyinfo">
                    <dl>
                        ...
                        <dd>
                            ...
                            <script>
                                ...
                                function jia(){
                                    ...
                                    num++;
                                    if(num > <?php echo ($list['num']); ?>){num=<?php echo ($list['num']); ?>;}
                        ...
                        <dd>
                            <div class="wrap_btn">
                                <a href="javascript:addToBuy()" class="wrap_btn2" title="立即兑换"><img src="/Public/Home/images/dh.png"></a>
                            </div>
                        </dd>
                    </dl>
                </div>
        ...
        <div class="p_right_info">
            ...
            <div class="Recommend">
                ...
                <div class="Recommend_list">
                    <ul>
                        <?php if(is_array($cateLikeList)): $i = 0; $__LIST__ = $cateLikeList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><li class="clearfix">
                            <div class="pic_img"><a href="<?php echo U('Detail/detail',array('gid'=>$val['id']));?>"><img src="/Public/Admin/Uploads/goods/<?php echo ($val['pic']); ?>" data-bd-imgshare-binded="1"></a></div>
                            <div class="r_content">
                                <div class="title"><a href="#"><?php echo ($val['goodsname']); ?></a></div>
                                <div class="p_Price">￥<?php echo ($val['price']); ?></div>
                            </div>
    ...
    <div class="clearfix">
        ...
        <div class="left_style">
            <div class="user_Records">
                ...
                <ul>
                    <?php if(is_array($historyInfo)): $k = 0; $__LIST__ = $historyInfo;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($k % 2 );++$k; if($k <= 6): ?><li>
                        <a href="<?php echo U('Detail/detail',array('gid'=>$val['id']));?>">
                            <p><img src="/Public/Admin/Uploads/goods/<?php echo ($val['pic']); ?>" data-bd-imgshare-binded="1"></p>
                            <p class="p_name"><?php echo ($val['goodsname']); ?></p>
                        </a>
                        <p><span class="p_Price"><i>￥</i><?php echo ($val['price']); ?></span><b><?php echo ($val['marketprice']); ?></b></p>
        ...
        十一、以上承诺如有违反，自愿接受农产品质量管理部门依照法律法规给予的处罚。
            ...
            <!--<div id="shangpjs" class="info_style" style="text-align:center"><img src="/Public/Home/images/products/cp.jpg" /></div>-->
        </div>
    </div>
</div>
