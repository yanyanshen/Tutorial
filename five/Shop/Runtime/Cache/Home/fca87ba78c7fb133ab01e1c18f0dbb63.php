    ...
    <div style="width:960px;float: left;height:800px;margin-top:-10px;">
        ...
        <div style="width:900px;height:500px;border:1px solid gray;">
            <table style="width:900px;">
                ...
                <?php if(is_array($msgInfo)): $k1 = 0; $__LIST__ = $msgInfo;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val1): $mod = ($k1 % 2 );++$k1;?><tr>
                    <td><?php echo ($k1); ?></td>
                    <td><?php echo ($val1['sender']); ?></td>
                    <td style="color:red"><?php echo ($val1['message']); ?></td>
                    <td><?php echo date("Y-m-d H:i:s",$val1['addtime']);?></td>
                    <td>
                        <a href="javascript:checkDetail(<?php echo ($val1['ag_id']); ?>)">查看详情</a>
                        <!--<a href="<?php echo U('Message/checkDetail',array('ag_id'=>$val1['ag_id']));?>">查看详情</a>-->
                    </td>
...
<script>
    function checkDetail(id){
        layer.open({
            ...
            shadeClose: true,
            shade: 0.8,
            content:"<?php echo U('Message/checkDetail');?>?ag_id="+id
        })
    }
</script>
