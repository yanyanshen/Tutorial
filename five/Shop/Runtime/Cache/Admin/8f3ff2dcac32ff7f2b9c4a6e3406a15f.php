...
<body>
    ...
    <div id="usual1" class="usual"> 
  	<div id="tab1" class="tabson">
        <form id="form1" action="<?php echo U('addlist');?>" method="post" enctype="multipart/form-data">
            <ul class="forminfo">
            ...
            <li><label>品牌LOGO<b>*</b></label>
                ...
                <div class="logobox">
                    <div class="resizebox">
                        <img id="img0" src="/Public/Admin/Uploads/default.png" width="180px"   height="110px"/>
                    </div>
                </div>
            ...
            $(this).ajaxSubmit(function(res) {
                if(res.status=="ok"){
                   layer.confirm(res.msg,{icon:3,btn:['确定','取消']},function(){
                       window.location.href="<?php echo U('Brand/addlist');?>";
                   },function(){
