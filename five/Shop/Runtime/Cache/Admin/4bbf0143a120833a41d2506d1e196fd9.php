...
<frameset rows="88,*,31" cols="*" frameborder="no" border="0" framespacing="0">
    ...
    <frameset cols="187,*" frameborder="no" border="0" framespacing="0">
        ...
        <frame src="<?php echo U('Admin/Index/main');?>" name="rightFrame" id="rightFrame" title="rightFrame" />
    </frameset>
    <frame src="<?php echo U('Admin/Index/footer');?>" name="bottomFrame" scrolling="No" noresize="noresize" id="bottomFrame" title="bottomFrame" />
