    ...
    <div class="formbody">
        <div id="usual1" class="usual">
  	        <div id="tab1" class="tabson">
                <ul class="forminfo">
                    <form id="myForm" action="<?php echo U('Admin/Ads/addlist');?>" method="post"  enctype="multipart/form-data">
                        ...
                        <li>
                            ...
                            <div class="imagBox ">
                                <div class="imgsml">
                                    <img id="img0"  src="/Public/Admin/Uploads/default.png" alt="" width="150px" height="100px"/>
                                </div>
                            </div>
            ...
            $(this).ajaxSubmit(function(res){
                if(res.status=="ok"){
                    layer.confirm(res.msg,{icon:3,btn:['确定','取消']},function(){
                        window.location.href="<?php echo U('Ads/addlist');?>";
                    },function(){
