...
<body>
    ...
    <div id="usual1" class="usual"> 
  	<div id="tab1" class="tabson">
        <form action="<?php echo U('News/addlist');?>" method="post" id="form1">
    <ul class="forminfo">
...
<script>
    $(function(){
        $(".btn").click(function(){
            $.post("<?php echo U('News/addlist');?>",$("#form1").serialize(),function(res){
                if(res.status=="ok"){
                    layer.confirm(res.msg,{icon:1,btn:["继续","算了"]},function(){
                        window.location.href="<?php echo U('News/addlist');?>";
                    },function(){
