...
<div class="part2">
    <div class="part2Cont frm_sty">
        <?php if(($goodslist) > "0"): ?><h1>一共有<?php echo ($count); ?>条浏览记录</h1>
            <a href="javascript:del()" style="float:right">清除所有浏览记录</a>
    </div>
</div>
<!-- part2结束    -->
...
<div class="part3">
    <div class="part3Cont frm_sty">
        ...
        <div class="btm">
            <ul class="clearfix">
                <?php if(is_array($goodslist)): $i = 0; $__LIST__ = $goodslist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i; if(is_array($val)): $i = 0; $__LIST__ = $val;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><li class="all">
                        <div class="left" ><a href="<?php echo u('Index/detail',array('gid'=>$v['gid']));?>">
                            <img  id="big" src="/Public/Uploads/goods/<?php echo ($v["pic"]); ?>" alt="" /></a>
                            <p class="p1"><?php echo ($v["goodsname"]); ?><br/><span class="span1"><?php echo ($v["description"]); ?></span><br /><span class="span2">￥<?php echo ($v["price"]); ?></span></p>
                            <a href="<?php echo u('Index/detail',array('gid'=>$v['gid']));?>"><p class="p2">去看看</p></a>
                            <a href="javascript:del(<?php echo ($v['gid']); ?>)" style="float:right">删除记录&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</p></a>
...
<!-- footer开始 -->
<?php else: ?><h1>暂时没有浏览记录,去逛逛逛吧!</h1><?php endif; ?>
...
<script>
     function del(gid){
        ...
        layer.confirm('您确定要删除吗?', {
            ...
            $.get("<?php echo U('Home/Index/del');?>",{'gid':gid},function(res){
                if(res.status=='ok'){
                    layer.alert(res.msg,{
                        yes:function(){
                            location.reload();
                    ...
                    layer.alert(res.msg);
                    location.href="<?php echo U('Home/Index/myfoot');?>";
                }
            });
        });
    }
