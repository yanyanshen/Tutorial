...
<div class="cont">
    <div class="middle">
        <div class="right fr clearfix">
            <ul>
                <li class="li1"><p>已有账号，<span><a href="<?php echo u('User/login');?>">立即登录</a></span></p></li>
                <li class="li2"><h3>免费注册</h3></li>
                <li class="li3">
                    <form action="<?php echo u('User/register');?>" method="post" id="form1" enctype="multipart/form-data">
...
<script type="text/javascript">
    $(function(){
        ...
        $('#li4').click(function(){
            if(validate.form()){
                $.post("<?php echo U('Home/User/register');?>",$('#form1').serialize(),function(res){
                    if(res.status=='ok'){
                        layer.msg(res.msg,{
                            icon: 1,
                            time: 1000
