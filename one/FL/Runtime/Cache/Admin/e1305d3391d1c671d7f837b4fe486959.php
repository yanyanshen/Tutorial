...
<form action="<?php echo u('Admin/Admin/adminList');?>" method="post" id="searchForm">
    <ul class="searchform">
        ...
        <div id="tab2" class="tabson">
            <table class="tablelist">
                ...
                <?php if(is_array($adminList)): $k = 0; $__LIST__ = $adminList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$pval): $mod = ($k % 2 );++$k;?><tr>
                        ...
                        <td class="<?php echo ($pval[admin_go]?'coo':'cooo'); ?>"><?php echo ($pval[admin_go]?'禁用':'启用'); ?></td>
                        <td><a href="<?php echo U('Admin/Admin/editAdmin',array('id'=>$pval[id]));?>" class="tablelink">编辑</a><?='&nbsp;&nbsp;&nbsp;'?>
                            <a href="#" class="tablelink" onclick="go(<?php echo ($pval['id']); ?>)"><?php echo ($pval[admin_go]?'启用':'禁用'); ?></a><?='&nbsp;&nbsp;&nbsp;'?>
