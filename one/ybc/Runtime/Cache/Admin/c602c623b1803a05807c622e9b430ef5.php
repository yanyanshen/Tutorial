    ...
    <div id="usual1" class="usual">
        <div id="tab1" class="tabson">
            <form action="" method="post" id="form1">
                <ul class="forminfo">
                    <li><label>菜单分类<b>*</b></label><input type="text" class="dfinput" disabled value="<?php echo ((isset($pname) && ($pname !== ""))?($pname):'顶级菜单'); ?>"  style="width:400px;"/></li>
                    <input name="pid" type="hidden" class="dfinput" value="<?php echo ((isset($pid) && ($pid !== ""))?($pid):0); ?>"  style="width:400px;"/>
                    <li><label>子菜单名称<b>*</b></label><input name="navname" type="text" class="dfinput" placeholder="请填写菜单名称"  style="width:400px;"/></li>
