...
<body>
    ...
    <div id="usual1" class="usual"> 
  	<div id="tab1" class="tabson">
        ...
        <form action="<?php echo U('Integral/addgoods');?>" method="post" enctype="multipart/form-data" id="goodsform">
    <ul class="forminfo">
            <ul class="forminfo">
                <li><label>商品名称<b>*</b></label><input name="goodsname" type="text" class="dfinput" value=""  style="width:520px;"/><label></label></li>
                <li><label>商城价格<b>*</b></label><input name="price" type="text" class="dfinput" value=""  style="width:520px;"/></li>
                <li><label>商城积分<b>*</b></label><input name="points" type="text" class="dfinput" value=""  style="width:520px;"/></li>
                <li>
