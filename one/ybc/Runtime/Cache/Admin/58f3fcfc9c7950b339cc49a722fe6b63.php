...
$(document).ready(function(e) {
    ...
    <script type="text/javascript">
          $(function(){
              $('#add').click(function(){
                  $.post("<?php echo U('Category/editcate');?>",$('#cateform').serialize(),function(res){
                        if(res.status==1){
...
<body>
    ...
    <div id="usual1" class="usual"> 
  	<div id="tab1" class="tabson">
        ...
        <form action="<?php echo U('Category/editcate');?>" method="post" id="cateform">
            <input type="hidden" name="id" value="<?php echo ($res["id"]); ?>"/>
    <ul class="forminfo">
    <li><label>分类名称<b>*</b></label><input name="catename" type="text" class="dfinput" value="<?php echo ($res['catename']); ?>"  style="width:167px;"/></li>
    <li><label>分类选择<b>*</b></label>
        <div class="vocation" >
            <select class="select2" name="pid">
                <option value="<?php echo ($res['pid']); ?>"><?php echo ($catename['catename']); ?></option>
