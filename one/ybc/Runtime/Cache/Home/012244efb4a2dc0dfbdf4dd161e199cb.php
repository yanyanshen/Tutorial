        ...
        <div class="right_style r_user_style">
            <div class="user_Borders">
                ...
                <div class="user_integral_style slideTxtBox">
                    <div class="bd" >
                        <ul>
                            <li style="margin-top: 50px;font-size: 18px;"><span style="color:green">来源：</span><?php echo ($info["from"]); ?></li>
                            <li style="margin-top: 50px;font-size: 18px;"><span style="color: green;">时间：</span><?php echo (date('Y-m-d H:i:s',$info["time"])); ?></li>
                            <li style="margin-top: 50px;font-size: 18px;"><span style="color:green">标题：</span><?php echo ($info["title"]); ?></li>
                            <li style="margin-top: 50px;font-size: 18px;"><span style="color:green">内容：</span><?php echo ($info["message"]); ?></li>
                        </ul>
