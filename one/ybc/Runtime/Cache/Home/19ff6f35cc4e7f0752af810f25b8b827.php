    ...
    <div class="Address_List">
        ...
        <div class="list">
            <table>
                ...
                <?php if(is_array($addrInfo)): $i = 0; $__LIST__ = $addrInfo;if( count($__LIST__)==0 ) : echo "$empty" ;else: foreach($__LIST__ as $key=>$va): $mod = ($i % 2 );++$i;?><tr><td><?php echo ($va["name"]); ?></td>
                        <td><?php echo ($va["address"]); ?></td>
                        <td><?php echo ($va["phone"]); ?></td>
                        <td><?php echo ($va["postcode"]); ?></td>
                        <?php if($new): ?><td><a href="<?php echo U('xzdz');?>?aid=<?php echo ($va["id"]); ?>&oid=<?php echo ($oid); ?>&new=<?php echo ($new); ?>">选择</a></td>
                            <?php else: ?>
                            <td><a href="<?php echo U('xzdz');?>?aid=<?php echo ($va["id"]); ?>&oid=<?php echo ($oid); ?>">选择</a></td><?php endif; ?>
