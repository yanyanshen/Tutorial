     ...
     <div class="right_style r_user_style">
      ...
      <div class="title_name">
       ...
       <div class="user_integral_style slideTxtBox">
         <div class="bd">
             <ul class="htm1">
                     <div class="Integral_Number">你的消息：<b><?php echo ($all); ?>&nbsp;条</b></div>
                     <div class="Integral_Number">当前未读消息：<b><?php echo ($unNum); ?>&nbsp;条</b></div>
                 <table>
                     <thead>
                     <tr>
                         <td>标题</td>
                     ...
                     <?php if(is_array($info)): $i = 0; $__LIST__ = $info;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><tr>
                             <td><a href="<?php echo U('UserCenter/msg1',array('id'=>$val['id']));?>" title="<?php echo ($val["title"]); ?>" style="column-rule: #cccccc;;cursor: pointer;"><?php echo (truncate_cn($val["title"],30,'',0)); ?>...</a></td>
                             <td><?php echo ($val["from"]); ?></td>
                             <td><?php echo (date('Y-m-d H:i:s',$val["time"])); ?></td>
                             <?php if($val['status'] == 0): ?><td><a href="<?php echo U('UserCenter/msg1',array('id'=>$val['id']));?>" style="color:red;cursor: pointer;">未读/点击查看</a></td>
                                 <?php else: ?>
                                 <td><a href="<?php echo U('UserCenter/msg1',array('id'=>$val['id']));?>" style="column-rule: #cccccc;;cursor: pointer;">已读/点击查看</a></td><?php endif; ?>
                         </tr><?php endforeach; endif; else: echo "" ;endif; ?>

                     </tbody>
                 </table>
                 <div>
                     <div class="message">共<i><?php echo ($count); ?></i>条记录，当前显示第&nbsp;<i style="color: deepskyblue"><?php echo ($firstRow/4+1); ?>&nbsp;</i>页</div>
                     <div class="pag"  style="float:right;"><?php echo ($page); ?></div>
                 </div>
             </ul>
         </div>
       </div>
