...
<body>
<div class="buyerbox box" style="width: 1000px;">
    ...
    <div class="orderprocon">
        <div class="clearfix" style="width:100%;">
            <div class="orderprodiv clearfix">
                ...
                <p><span>商品名称：</span><em class="orderred"><?php echo mb_substr($info['goodsname'],0,25,'utf-8');?></em></p>
            ...
            <div class="orderprodiv clearfix" style="position:relative;margin-top: -240px;">
