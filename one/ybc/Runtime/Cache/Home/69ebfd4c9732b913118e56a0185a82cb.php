        ...
        <div class="right_style r_user_style">
            <div class="user_Borders">
                <div class="Address_List">
                    <div class="list">
                        <?php if(empty($collectList)): ?><h1 style="color: lightseagreen">你还没有收藏过任何商品，赶紧去逛逛吧！</h1>
                            <?php else: ?>
                            <table style="margin-bottom: 30px;">
                                ...
                                <?php if(is_array($collectList)): $i = 0; $__LIST__ = $collectList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$data): $mod = ($i % 2 );++$i;?><tr>
                                        <td><a href="<?php echo U('Detail/detail');?>?id=<?php echo ($data["gid"]); ?>"><img src="/Uploads/goodsPic/100/100_<?php echo ($data["pic"]); ?>" alt=""/></a></td>
                                        <td><a href="<?php echo U('Detail/detail');?>?id=<?php echo ($data["gid"]); ?>"><?php echo ($data["goodsname"]); ?></a></td>
                                        <td><?php echo ($data["price"]); ?></td>
                                        <td><?php echo date("Y-m-d",$data['addtime']);?></td>
                                        <td><a onclick="cel(<?php echo ($data["gid"]); ?>)" style="cursor: pointer">取消收藏</a></td>
