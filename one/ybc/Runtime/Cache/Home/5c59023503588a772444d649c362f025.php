...
<script type="text/javascript">
    $(function(){
        ...
        sqsh=function(id){
            $.post("<?php echo U('Order/chkHis');?>",{id:id},function(res){
                if(res.status==1){
                    layer.confirm("请选择售后类型？",{btn:['我要换货','我要退货'],title:"请选择"},function(){
                        location="<?php echo U('Order/erGoods');?>?hid="+id+"&type=1";
                    },function(){
                        location="<?php echo U('Order/erGoods');?>?hid="+id+"&type=2";
                    });
                }else{
            ...
            <div class="user_Borders">
                ...
                <div class="Address_List">
                    <div class="title_name"><span class="name">已购买的商品</span>
                            ...
                            <a style="float: right;" href="<?php echo U('Order/myServices');?>">【我申请的售后】</a>

                    </div>

                    <div class="list">
                        <?php if(empty($history['list'])): ?><h1 style="color: red">你还没有购买过任何商品，赶紧去shopping吧！</h1>
                            <?php else: ?>
                            <table style="margin-bottom: 30px;">
                                ...
                                <?php if(is_array($history['list'])): $i = 0; $__LIST__ = $history['list'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$va): $mod = ($i % 2 );++$i;?><tr>
                                        ...
                                        <td><?php echo date("Y-m-d",$va['buytime']);?></td>
                                        <td>
                                            <?php if($va['buytime'] > $time): ?><a onclick="sqsh(<?php echo ($va["id"]); ?>)" style="cursor: pointer">申请售后</a>
                                                <?php else: ?>
                                                不可申请<?php endif; ?>
                        ...
                        <div class="page" style=" float:left;"><?php echo ($history['show']); ?></div>
