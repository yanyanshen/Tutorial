...
<!--<script src="/Public/Home/js/upload.js" type="text/javascript"></script>-->
<script src="/Public/Home/js/uploadPreview.min.js" type="text/javascript"></script>
<title>用户中心</title>
</head>
<script>
    $(function(){
  ...
  <div class="clearfix user" >
    ...
    <div class=" right_style r_user_style">
      <div class="user_Borders">
       ...
       <form id="form1" name="form1" action="<?php echo U('UserCenter/saveinfo');?>" method="post" enctype="multipart/form-data">
       <div class="user_layout">
           <?php if(is_array($userInfo)): $i = 0; $__LIST__ = $userInfo;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><ul >
             <?php if(!isset($_SESSION['avatar1'])): ?><li style="height: 100px"><label class="user_title_name">用户头像：</label><span id="imgdiv"><img src="/Public/Home/images/deavatar.jpg" id="imgShow" style="width:100px; height:100px;border-radius: 50px" /></span>
                     <input type="file" id="image1" name="avatar" value=""/>
                 </li>
                 <?php else: ?>
          <li style="height: 100px"><label class="user_title_name">用户头像：</label><span id="imgdiv"><img src="/Uploads/avatar/100/100_<?php echo ($val["avatar"]); ?>" id="imgShow" style="width:100px; height:100px;border-radius: 50px" /></span>
              <input type="file" id="image1" name="avatar" value=""/>
          </li><?php endif; ?>
          <li><label class="user_title_name">用&nbsp;户&nbsp;名：</label><input name="username" value="<?php echo ($val["username"]); ?>" type="text"  class="add_text"/><i>*</i></li>
          <li><label class="user_title_name">性&nbsp;&nbsp;&nbsp;&nbsp;别：</label>
              <?php if($val["sex"] == 1): ?><label class="sex"> <input type="radio" name="sex" value="1" id="RadioGroup1_0" checked/><span>男</span></label>
                <label class="sex"><input type="radio" name="sex" value="2" id="RadioGroup1_1" /><span>女</span></label>
                  ...
                  <label class="sex"><input type="radio" name="sex" value="2" id="RadioGroup1_1" checked/><span>女</span></label><?php endif; ?>
                <i>*</i>         
          </li>
          <li><label class="user_title_name">手&nbsp;机&nbsp;号：</label><input name="mobile" value="<?php echo ($val["mobile"]); ?>" type="text"  class="add_text"/><i>*</i></li>
          <li><label class="user_title_name">邮箱地址：</label><input name="mail" value="<?php echo ($val["mail"]); ?>" type="text"  class="add_text"/><i>*</i></li>
          <li><label class="user_title_name">Q&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Q：</label><input name="qq" value="<?php echo ($val["qq"]); ?>" type="text"  class="add_text"/><i>*</i></li>
