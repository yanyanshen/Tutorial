			...
			<div class="shop_meber_bd_good_lists clearfix">
				...
				<div  class="shop_home_form">
					<form action="" name="" class="shop_form" method="post">
						<ul>
                            <?php if(is_array($grxx)): $k = 0; $__LIST__ = $grxx;if( count($__LIST__)==0 ) : echo "$empty" ;else: foreach($__LIST__ as $key=>$value): $mod = ($k % 2 );++$k;?><li><label for="">&nbsp;&nbsp;&nbsp;&nbsp;用户名称：</label><?php echo ($value["username"]); ?></li>

                            <li><label for="">电子邮件：</label><?php echo ($value["email"]); ?></li>
                                <li><label for="">性&nbsp;&nbsp;&nbsp;&nbsp;别:</label>
                                    <?php echo ($value["sex"]); ?>

                                </li>

                            <li><label for="">电&nbsp;&nbsp;&nbsp;&nbsp;话:</label><?php echo ($value["mobile"]); ?></li>
                            <li><label for="">联系地址:</label>
