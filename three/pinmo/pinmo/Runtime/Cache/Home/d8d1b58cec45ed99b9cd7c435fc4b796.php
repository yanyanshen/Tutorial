    ...
    <div class="contents clearfix">
		...
		<div class="shop_bd_list_right clearfix">
			...
			<div class="module_filter">
                <p style="font-size: 18px">&nbsp;&nbsp;&nbsp;&nbsp;欢迎来到<?php echo ($pd); ?>频道</p>
			...
			<div class="shop_bd_list_content clearfix" id="pxlist">
				<ul>
					<?php if(is_array($letlist)): $i = 0; $__LIST__ = $letlist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$value): $mod = ($i % 2 );++$i;?><li>
                        <dl>
...
<script type="text/javascript">
    ...
    function change(id){
        ...
        var id=id;var cid=<?php echo ($cid); ?>;
//alert (id);
        $.get("<?php echo U('Home/Index/letter');?>",{"p":id,"cid":cid},function(res){
            $("#pxlist").html(res);
        })
    }
</script>
