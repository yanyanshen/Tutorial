...
<head>
    ...
    <title>个人头像</title>
    <link rel="stylesheet" href="/three17/pinmo/Public/Home/css/base.css" type="text/css" />
    <link rel="stylesheet" href="/three17/pinmo/Public/Home/css/shop_common.css" type="text/css" />
    <link rel="stylesheet" href="/three17/pinmo/Public/Home/css/shop_header.css" type="text/css" />
    <link rel="stylesheet" href="/three17/pinmo/Public/Home/css/shop_manager.css" type="text/css" />
    <link rel="stylesheet" href="/three17/pinmo/Public/Home/css/shop_form.css" type="text/css" />
    <script type="text/javascript" src="/three17/pinmo/Public/Home/js/jquery-1.8.2.js" ></script>
    <script type="text/javascript" src="/three17/pinmo/Public/Home/js/topNav.js" ></script>
    <script type="text/javascript" src="/three17/pinmo/Public/Home/js/geo.js"></script>
    <script type="text/javascript" src="/three17/pinmo/Public/Home/js/jquery.form.js"></script>
    <style type="text/css">
        .selectImg{
...
<div class="shop_hd">
    ...
    <div class="shop_hd_header">
        <div class="shop_hd_header_logo">
            ...
            <?php if(is_array($list6)): $i = 0; $__LIST__ = $list6;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$value): $mod = ($i % 2 );++$i;?><h1 class="logo"><a href=""><img src="/three17/pinmo/Uploads/<?php echo ($value["adpic"]); ?>" alt="" width="250px" height="80px"/></a><span>1234</span></h1><?php endforeach; endif; else: echo "" ;endif; ?>
        </div>
            ...
            <div id="shop_hd_menu_all_category_hd" class="shop_hd_menu_all_category_hd">
                <ul class="shop_hd_menu_all_category_hd_menu clearfix">
                   ...
                   <div class="cat_menu clearfix" style="margin-bottom: 0px">
                        <dl class="clearfix">
                    <?php if(is_array($blist)): $i = 0; $__LIST__ = $blist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$value): $mod = ($i % 2 );++$i;?><dd><img src="/three17/pinmo/Uploads/<?php echo ($value["pic"]); ?>" width="150px" style="margin:5px "/></dd><?php endforeach; endif; else: echo "" ;endif; ?>
                    </dl>
                       </div>
                    <li>-->
...
<div class="clear"></div>
<script src="/three17/pinmo/Public/Home/js/jquery-1.8.2.js"></script>
<script src="/three17/pinmo/Public/Home/layer/layer.js"></script>
<script>
...
<div class="shop_member_bd clearfix">
    ...
    <div class="shop_member_bd_left_pic">
        <a href="<?php echo U('Home/MemberCenter/photo');?>"><img src="/three17/pinmo/Uploads/<?php echo ($photo); ?>" /></a>
    </div>
    <div class="clear"></div>
    <dl>
        <dt>我的账户</dt>
    ...
    <div>
        <form action="<?php echo U('Home/MemberCenter/photo');?>" id="form1" method="post" enctype="multipart/form-data" >
            <div id="preview"></div>
            <input  type="file" id="photo1" onchange="preview(this)" name="photo" style="display: none"/>
            <label for="photo1" class="selectImg">添加图片</label>
            <input type="submit"  id="photo2" style="display: none">
            <label for="photo2" class="selectImg">立即上传</label>
        </form>
    </div>
</div>
        ...
        $('#form1').ajaxSubmit(function (res) {
            ...
            if(res.status=='ok'){
                layer.msg(res.msg,
                        {
                            yes: function () {
                                location.href = "<?php echo U('Home/MemberCenter/grxx');?>";
                            }
                        })
            }else{
