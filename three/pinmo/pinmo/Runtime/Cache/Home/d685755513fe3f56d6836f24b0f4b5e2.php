		...
		<div class="shop_member_bd_right clearfix">
			...
			<div class="shop_meber_bd_good_lists clearfix">
				...
				<div  class="shop_home_form">
					<form action="<?php echo U('MemberCenter/member_info');?>" name="" id="form" class="shop_form" method="post">
						<ul>
							<li><label for="">用户名称：</label><?php echo (session('mname')); ?><input name="username" type="hidden" value="<?php echo (session('mname')); ?>"/></li>
...
<script src="/three17/pinmo/Public/Home/layer/layer.js"></script>
<script src="/three17/pinmo/Public/Home/js/jquery.validate.min.js"></script>
<script>
    $(function() {
        ...
        $('#submit').click(function () {
            if(validate.form()){
                $.post("<?php echo U('Home/MemberCenter/member_info');?>", $('.shop_form').serialize(), function (res) {
                    if (res.status == 'ok') {
                        layer.alert(res.msg, {
                            yes: function () {
