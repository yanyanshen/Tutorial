...
<head>
    ...
    <script type="text/javascript" src="/Public/Admin/editor/kindeditor-all.js"></script>
...
<div class="formbody">
    <div id="usual1" class="usual">
        <div id="tab1" class="tabson">
            <form action="<?php echo U('Goods/add');?>" method="post" id="form" enctype="multipart/form-data">
                <ul class="forminfo">
                    ...
                    <li><label>市场价格<b>*</b></label>
                        <input name="marketprice" type="text" class="dfinput" value=""  style="width:518px;"/>
                    </li>
                    <li><label>商城价格<b>*</b></label>
                        <input name="price" type="text" class="dfinput" value=""  style="width:518px;"/>
                    </li>
                    <li><label>库存<b>*</b></label>
                        <input name="num" type="text" class="dfinput" value=""  style="width:518px;"/>
                    </li>
                    ...
                    <li><label>商品分类<b>*</b></label>
                        ...
                        <div class="vocation">
                            <select  name="cid" id="select2" value="">
