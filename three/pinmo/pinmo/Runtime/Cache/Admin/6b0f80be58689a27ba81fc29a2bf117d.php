...
<div class="formbody">
    <div id="usual1" class="usual">
        <div id="tab1" class="tabson">
            <form action="<?php echo U('Admin/Ad/edit');?>" method="post" id="form" enctype="multipart/form-data">
                <ul class="forminfo">
                    <?php if(is_array($adlist)): $i = 0; $__LIST__ = $adlist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$value): $mod = ($i % 2 );++$i;?><li><label>广告名称<b>*</b></label>
                        <input name="adname" type="text" class="dfinput" value="<?php echo ($value["adname"]); ?>"  style="width:518px;"/>
                    </li>

                    <li><input name="id" type="hidden" value=<?php echo ($value["id"]); ?> /></li>
                        <li><label>广告添加链接<b>*</b></label>
                            <input name="adurl" type="text" class="dfinput" value="<?php echo ($value["adurl"]); ?>"  style="width:518px;"/>
